...
public class Class30_Sub2_Sub1_Sub3 extends Class30_Sub2_Sub1
{
    ...
    {
        anIntArray1472 = new int[Class30_Sub2_Sub1.height];
        if(byte0 == 6)
        {
            byte0 = 0;
        } else
        ...
        for(int j = 0; j < Class30_Sub2_Sub1.height; j++)
            anIntArray1472[j] = Class30_Sub2_Sub1.width * j;
    ...
    public static final void method368(Class44 class44, int i)
    {
        ...
        for(int j = 0; j < 50; j++)
            try
            {
                ...
                if(aBoolean1461 && aClass30_Sub2_Sub1_Sub2Array1474[j].panelWidth == 128)
                    aClass30_Sub2_Sub1_Sub2Array1474[j].method356(false);
                else
                    aClass30_Sub2_Sub1_Sub2Array1474[j].incImgSizeNoScale(false);
                anInt1473++;
            }
            catch(Exception _ex) { }
 ...
 */
 ...
 //   	i = random(40);
        ...
        if(aBoolean1461)
        {
            ...
            {
                int i2 = ai[i1] = ai1[class30_sub2_sub1_sub2.imageArray[i1]] & 0xf8f8ff;
                if(i2 == 0)
        ...
        {
            if(class30_sub2_sub1_sub2.imageWidth == 64)
            {
                for(int j1 = 0; j1 < 128; j1++)
                {
                    for(int j2 = 0; j2 < 128; j2++)
                        ai[j2 + (j1 << 7)] = ai1[class30_sub2_sub1_sub2.imageArray[(j2 >> 1) + ((j1 >> 1) << 6)]];
            ...
            } else
            {
                for(int k1 = 0; k1 < 16384; k1++)
                    ai[k1] = ai1[class30_sub2_sub1_sub2.imageArray[k1]];
    ...
    public static final void method372(double d, byte byte0)
    {
        ...
        for(int l = 0; l < 50; l++)
            ...
            {
                int ai[] = aClass30_Sub2_Sub1_Sub2Array1474[l].texturesArray1;
            ...
            int i2)
    {
        ...
        if(i <= j && i <= k)
        {
            if(i >= Class30_Sub2_Sub1.endHeight)
                return;
            if(j > Class30_Sub2_Sub1.endHeight)
                j = Class30_Sub2_Sub1.endHeight;
            if(k > Class30_Sub2_Sub1.endHeight)
                k = Class30_Sub2_Sub1.endHeight;
            if(j < k)
            {
                j1 = l <<= 16;
                i2 = k1 <<= 15;
                ...
                if(i != j && j3 < j2 || i == j && j3 > l2)
                {
                    k -= j;
                    j -= i;
                    for(i = anIntArray1472[i]; --j >= 0; i += Class30_Sub2_Sub1.width)
                    {
                        method375(Class30_Sub2_Sub1.pixelsArray, i, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                        j1 += j3;
                        l += j2;
                        i2 += k3;
                        k1 += k2;
                    ...
                    while(--k >= 0) 
                    {
                        method375(Class30_Sub2_Sub1.pixelsArray, i, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                        j1 += j3;
                        i1 += l2;
                        i2 += k3;
                        l1 += i3;
                        i += Class30_Sub2_Sub1.width;
                    }
                    return;
                }
                k -= j;
                ...
                for(i = anIntArray1472[i]; --j >= 0; i += Class30_Sub2_Sub1.width)
                {
                    method375(Class30_Sub2_Sub1.pixelsArray, i, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                    j1 += j3;
                    l += j2;
                    i2 += k3;
                    k1 += k2;
                ...
                while(--k >= 0) 
                {
                    method375(Class30_Sub2_Sub1.pixelsArray, i, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    j1 += j3;
                    i1 += l2;
                    i2 += k3;
                    l1 += i3;
            ...
            if(i != k && j3 < j2 || i == k && l2 > j2)
            {
                j -= k;
                k -= i;
                for(i = anIntArray1472[i]; --k >= 0; i += Class30_Sub2_Sub1.width)
                {
                    method375(Class30_Sub2_Sub1.pixelsArray, i, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += j3;
                    l += j2;
                    l1 += k3;
                    k1 += k2;
            ...
            for(i = anIntArray1472[i]; --k >= 0; i += Class30_Sub2_Sub1.width)
            {
                method375(Class30_Sub2_Sub1.pixelsArray, i, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += j3;
                l += j2;
                l1 += k3;
                k1 += k2;
        ...
        if(j <= k)
        {
            ...
            if(k < i)
            {
                ...
                if(j != k && j2 < l2 || j == k && j2 > j3)
                {
                    i -= k;
                    k -= j;
                    for(j = anIntArray1472[j]; --k >= 0; j += Class30_Sub2_Sub1.width)
                    {
                        method375(Class30_Sub2_Sub1.pixelsArray, j, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                        l += j2;
                        i1 += l2;
                        k1 += k2;
                        l1 += i3;
                    ...
                    while(--i >= 0) 
                    {
                        method375(Class30_Sub2_Sub1.pixelsArray, j, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                        l += j2;
                        j1 += j3;
                        k1 += k2;
                        i2 += k3;
                        j += Class30_Sub2_Sub1.width;
                    }
                    return;
                }
                i -= k;
                ...
                for(j = anIntArray1472[j]; --k >= 0; j += Class30_Sub2_Sub1.width)
                {
                    method375(Class30_Sub2_Sub1.pixelsArray, j, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    l += j2;
                    i1 += l2;
                    k1 += k2;
                    l1 += i3;
                ...
                while(--i >= 0) 
                {
                    method375(Class30_Sub2_Sub1.pixelsArray, j, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                    l += j2;
                    j1 += j3;
                    k1 += k2;
                    i2 += k3;
            ...
            if(j2 < l2)
            {
                k -= i;
                i -= j;
                for(j = anIntArray1472[j]; --i >= 0; j += Class30_Sub2_Sub1.width)
                {
                    method375(Class30_Sub2_Sub1.pixelsArray, j, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                    j1 += j2;
                    i1 += l2;
                    i2 += k2;
                    l1 += i3;
            ...
            for(j = anIntArray1472[j]; --i >= 0; j += Class30_Sub2_Sub1.width)
            {
                method375(Class30_Sub2_Sub1.pixelsArray, j, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                j1 += j2;
                i1 += l2;
                i2 += k2;
                l1 += i3;
        ...
        if(i < j)
        {
            ...
            if(l2 < j3)
            {
                j -= i;
                i -= k;
                for(k = anIntArray1472[k]; --i >= 0; k += Class30_Sub2_Sub1.width)
                {
                    method375(Class30_Sub2_Sub1.pixelsArray, k, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    i1 += l2;
                    j1 += j3;
                    l1 += i3;
                    i2 += k3;
                ...
                while(--j >= 0) 
                {
                    method375(Class30_Sub2_Sub1.pixelsArray, k, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += l2;
                    l += j2;
                    l1 += i3;
                    k1 += k2;
                    k += Class30_Sub2_Sub1.width;
                }
                return;
            }
            j -= i;
            ...
            for(k = anIntArray1472[k]; --i >= 0; k += Class30_Sub2_Sub1.width)
            {
                method375(Class30_Sub2_Sub1.pixelsArray, k, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                i1 += l2;
                j1 += j3;
                l1 += i3;
                i2 += k3;
            ...
            while(--j >= 0) 
            {
                method375(Class30_Sub2_Sub1.pixelsArray, k, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += l2;
                l += j2;
                l1 += i3;
                k1 += k2;
        ...
        if(l2 < j3)
        {
            i -= j;
            j -= k;
            for(k = anIntArray1472[k]; --j >= 0; k += Class30_Sub2_Sub1.width)
            {
                method375(Class30_Sub2_Sub1.pixelsArray, k, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                l += l2;
                j1 += j3;
                k1 += i3;
                i2 += k3;
        ...
        for(k = anIntArray1472[k]; --j >= 0; k += Class30_Sub2_Sub1.width)
        {
            method375(Class30_Sub2_Sub1.pixelsArray, k, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
            l += l2;
            j1 += j3;
            k1 += i3;
            i2 += k3;
        ...
        if(aBoolean1464)
        {
            ...
            if(aBoolean1462)
            {
                if(i1 - l > 3)
                    ...
                    l1 = 0;
                if(i1 > Class30_Sub2_Sub1.endWidthMinusOne)
                    i1 = Class30_Sub2_Sub1.endWidthMinusOne;
                if(l < 0)
                {
                    j1 -= l * l1;
                    l = 0;
    ...
    public static final void method376(int i, int j, int k, int l, int i1, int j1, int k1)
    {
        ...
        if(i <= j && i <= k)
        {
            ...
            if(j < k)
            {
                ...
                if(i != j && j2 < l1 || i == j && j2 > i2)
                {
                    ...
                    for(i = anIntArray1472[i]; --j >= 0; i += Class30_Sub2_Sub1.width)
                    {
                        method377(Class30_Sub2_Sub1.pixelsArray, i, k1, 0, j1 >> 16, l >> 16);
                        j1 += j2;
                        l += l1;
                    }
                    ...
                    while(--k >= 0) 
                    {
                        method377(Class30_Sub2_Sub1.pixelsArray, i, k1, 0, j1 >> 16, i1 >> 16);
                        j1 += j2;
                        i1 += i2;
                        i += Class30_Sub2_Sub1.width;
                    }
                ...
                for(i = anIntArray1472[i]; --j >= 0; i += Class30_Sub2_Sub1.width)
                {
                    method377(Class30_Sub2_Sub1.pixelsArray, i, k1, 0, l >> 16, j1 >> 16);
                    j1 += j2;
                    l += l1;
                }
                ...
                while(--k >= 0) 
                {
                    method377(Class30_Sub2_Sub1.pixelsArray, i, k1, 0, i1 >> 16, j1 >> 16);
                    j1 += j2;
                    i1 += i2;
                    i += Class30_Sub2_Sub1.width;
                }
            ...
            if(i != k && j2 < l1 || i == k && i2 > l1)
            {
                ...
                for(i = anIntArray1472[i]; --k >= 0; i += Class30_Sub2_Sub1.width)
                {
                    method377(Class30_Sub2_Sub1.pixelsArray, i, k1, 0, i1 >> 16, l >> 16);
                    i1 += j2;
                    l += l1;
                }
            ...
            for(i = anIntArray1472[i]; --k >= 0; i += Class30_Sub2_Sub1.width)
            {
                method377(Class30_Sub2_Sub1.pixelsArray, i, k1, 0, l >> 16, i1 >> 16);
                i1 += j2;
                l += l1;
            }
        ...
        if(j <= k)
        {
            ...
            if(k < i)
            {
                ...
                if(j != k && l1 < i2 || j == k && l1 > j2)
                {
                    ...
                    for(j = anIntArray1472[j]; --k >= 0; j += Class30_Sub2_Sub1.width)
                    {
                        method377(Class30_Sub2_Sub1.pixelsArray, j, k1, 0, l >> 16, i1 >> 16);
                        l += l1;
                        i1 += i2;
                    }
                    ...
                    while(--i >= 0) 
                    {
                        method377(Class30_Sub2_Sub1.pixelsArray, j, k1, 0, l >> 16, j1 >> 16);
                        l += l1;
                        j1 += j2;
                        j += Class30_Sub2_Sub1.width;
                    }
                ...
                for(j = anIntArray1472[j]; --k >= 0; j += Class30_Sub2_Sub1.width)
                {
                    method377(Class30_Sub2_Sub1.pixelsArray, j, k1, 0, i1 >> 16, l >> 16);
                    l += l1;
                    i1 += i2;
                }
                ...
                while(--i >= 0) 
                {
                    method377(Class30_Sub2_Sub1.pixelsArray, j, k1, 0, j1 >> 16, l >> 16);
                    l += l1;
                    j1 += j2;
                    j += Class30_Sub2_Sub1.width;
                }
            ...
            if(l1 < i2)
            {
                ...
                for(j = anIntArray1472[j]; --i >= 0; j += Class30_Sub2_Sub1.width)
                {
                    method377(Class30_Sub2_Sub1.pixelsArray, j, k1, 0, j1 >> 16, i1 >> 16);
                    j1 += l1;
                    i1 += i2;
                }
            ...
            for(j = anIntArray1472[j]; --i >= 0; j += Class30_Sub2_Sub1.width)
            {
                method377(Class30_Sub2_Sub1.pixelsArray, j, k1, 0, i1 >> 16, j1 >> 16);
                j1 += l1;
                i1 += i2;
            }
        ...
        if(i < j)
        {
            ...
            if(i2 < j2)
            {
                ...
                for(k = anIntArray1472[k]; --i >= 0; k += Class30_Sub2_Sub1.width)
                {
                    method377(Class30_Sub2_Sub1.pixelsArray, k, k1, 0, i1 >> 16, j1 >> 16);
                    i1 += i2;
                    j1 += j2;
                }
                ...
                while(--j >= 0) 
                {
                    method377(Class30_Sub2_Sub1.pixelsArray, k, k1, 0, i1 >> 16, l >> 16);
                    i1 += i2;
                    l += l1;
                    k += Class30_Sub2_Sub1.width;
                }
            ...
            for(k = anIntArray1472[k]; --i >= 0; k += Class30_Sub2_Sub1.width)
            {
                method377(Class30_Sub2_Sub1.pixelsArray, k, k1, 0, j1 >> 16, i1 >> 16);
                i1 += i2;
                j1 += j2;
            }
            ...
            while(--j >= 0) 
            {
                method377(Class30_Sub2_Sub1.pixelsArray, k, k1, 0, l >> 16, i1 >> 16);
                i1 += i2;
                l += l1;
                k += Class30_Sub2_Sub1.width;
            }
        ...
        if(i2 < j2)
        {
            ...
            for(k = anIntArray1472[k]; --j >= 0; k += Class30_Sub2_Sub1.width)
            {
                method377(Class30_Sub2_Sub1.pixelsArray, k, k1, 0, l >> 16, j1 >> 16);
                l += i2;
                j1 += j2;
            }
        ...
        for(k = anIntArray1472[k]; --j >= 0; k += Class30_Sub2_Sub1.width)
        {
            method377(Class30_Sub2_Sub1.pixelsArray, k, k1, 0, j1 >> 16, l >> 16);
            l += i2;
            j1 += j2;
        }
            ...
            int l3, int i4, int j4, int k4)
    {
        ...
        if(i <= j && i <= k)
        {
            ...
            if(j < k)
            {
                ...
                if(i != j && i8 < i7 || i == j && i8 > k7)
                {
                    ...
                    while(--j >= 0) 
                    {
                        method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        l += i7;
                        i2 += j8;
                        k1 += j7;
                    ...
                    while(--k >= 0) 
                    {
                        method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, i, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        i1 += k7;
                        i2 += j8;
                        l1 += l7;
                ...
                while(--j >= 0) 
                {
                    method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    l += i7;
                    i2 += j8;
                    k1 += j7;
                ...
                while(--k >= 0) 
                {
                    method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, i, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    i1 += k7;
                    i2 += j8;
                    l1 += l7;
            ...
            if(i != k && i8 < i7 || i == k && k7 > i7)
            {
                ...
                while(--k >= 0) 
                {
                    method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, i, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += i8;
                    l += i7;
                    l1 += j8;
                    k1 += j7;
            ...
            while(--k >= 0) 
            {
                method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, i, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += i8;
                l += i7;
                l1 += j8;
                k1 += j7;
        ...
        if(j <= k)
        {
            ...
            if(k < i)
            {
                ...
                if(j != k && i7 < k7 || j == k && i7 > i8)
                {
                    ...
                    while(--k >= 0) 
                    {
                        method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        i1 += k7;
                        k1 += j7;
                        l1 += l7;
                    ...
                    while(--i >= 0) 
                    {
                        method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, j, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        j1 += i8;
                        k1 += j7;
                        i2 += j8;
                ...
                while(--k >= 0) 
                {
                    method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    i1 += k7;
                    k1 += j7;
                    l1 += l7;
                ...
                while(--i >= 0) 
                {
                    method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, j, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    j1 += i8;
                    k1 += j7;
                    i2 += j8;
            ...
            if(i7 < k7)
            {
                ...
                while(--i >= 0) 
                {
                    method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, j, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i7;
                    i1 += k7;
                    i2 += j7;
                    l1 += l7;
            ...
            while(--i >= 0) 
            {
                method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, j, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                j1 += i7;
                i1 += k7;
                i2 += j7;
                l1 += l7;
        ...
        if(i < j)
        {
            ...
            if(k7 < i8)
            {
                ...
                while(--i >= 0) 
                {
                    method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, k, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    j1 += i8;
                    l1 += l7;
                    i2 += j8;
                ...
                while(--j >= 0) 
                {
                    method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, k, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    l += i7;
                    l1 += l7;
                    k1 += j7;
            ...
            while(--i >= 0) 
            {
                method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                j1 += i8;
                l1 += l7;
                i2 += j8;
            ...
            while(--j >= 0) 
            {
                method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, k, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                l += i7;
                l1 += l7;
                k1 += j7;
        ...
        if(k7 < i8)
        {
            ...
            while(--j >= 0) 
            {
                method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, k, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                l += k7;
                j1 += i8;
                k1 += l7;
                i2 += j8;
        ...
        while(--j >= 0) 
        {
            method379(Class30_Sub2_Sub1.pixelsArray, ai, 0, 0, k, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
            l += k7;
            j1 += i8;
            k1 += l7;
            i2 += j8;
    ...
    static 
    {
        ...
        anIntArray1470 = new int[2048]; // y coord of circle
        anIntArray1471 = new int[2048]; // x coord of circle
        for(int i = 1; i < anIntArray1468.length; i++)
            anIntArray1468[i] = 32768 / i;

        for(int j = 1; j < anIntArray1469.length; j++)
            anIntArray1469[j] = 0x10000 / j;

        for(int k = 0; k < anIntArray1470.length; k++)
        {
            anIntArray1470[k] = (int)(65536D * Math.sin((double)k * 2.0*Math.PI/anIntArray1470.length));
            anIntArray1471[k] = (int)(65536D * Math.cos((double)k * 2.0*Math.PI/anIntArray1471.length));
        }
