...
public final class client extends GameApplet {
	...
	public long lastResize = 1L;
	public long resizeInterval = 1000L;
	public boolean isResizingGame;
	public boolean notInLoginScreen;

	/**
	 * Handles correct keybinds when keys are down
	 * @param keyCode
	 * @param charCode
	 * @return
	 */
	public int checkKeybindsDown(int keyCode, int charCode)
	{
		if (keyCode >= 0 && keyCode < DefaultKeybinds.keybinds.length)
		{
			if (!isTyping)
			{
				charCode = DefaultKeybinds.keybinds[keyCode][1];
				/*
				int xOffset = 2;
				int yOffset = 20;
				switch (charCode)
				...
				case 70: //f
					if (keyDown[17] == 1)
					{
						getFrameComponent().setSize(gameWidth+20, gameHeight);
						getFrameComponent().setLocation(getFrameComponent().getX()+xOffset, getFrameComponent().getY()+yOffset);
						resizedWindow();
					}
					break;
				case 66: //b
				...
				case 80: //p
					if (keyDown[17] == 1)
					{
						getFrameComponent().setSize(gameWidth, gameHeight+20);
						getFrameComponent().setLocation(getFrameComponent().getX()+xOffset, getFrameComponent().getY()+yOffset);
						resizedWindow();
					}
					break;
			...
			else
			{
				...
				if(charCode < 30)
					charCode = 0;
				if(keyCode == 37)
					charCode = DefaultKeybinds.CAMERA_TURN_LEFT;
				if(keyCode == 39)
					charCode = DefaultKeybinds.CAMERA_TURN_RIGHT;
				if(keyCode == 38)
					charCode = DefaultKeybinds.CAMERA_TURN_UP;
				if(keyCode == 40)
					charCode = DefaultKeybinds.CAMERA_TURN_DOWN;
				if(keyCode == 17)
					charCode = 5;
				if(keyCode == 8)
					charCode = 8;
				...
				if(keyCode == 9)
					charCode = 9;
				if(keyCode == 10)
					charCode = 10; // return key
				if(keyCode >= 112 && keyCode <= 123)
					charCode = (1008 + keyCode) - 112;
				if(keyCode == 36)
					charCode = 1000;
				if(keyCode == 35)
					charCode = 1001;
	...
	/**
	 * Handles correct keybinds when keys are released
	 * @param keyCode
	 * @param charCode
	 * @return
	 */
	public int checkKeybindRelease(int keyCode, int charCode)
	{
	...
	/**
	 * @return the dimension of the game (e.g 765x503 if not fullscreen).
	 * If no dimension has been set it will return 0x0 (zero by zero).
	 */
	...
	/**
	 * Height of chatbox including borders and
	 * @return
	 */
	public int getChatboxHeight()
	{
		try
		{
			return Class15_Backbase10Height
					+ Class15_ChatboxHeight
					+ Class15_BackHmMd20Height;
		} catch(NullPointerException npe)
		{
			System.err.println("One or more of Class15_Backbase10Height, " +
					"Class15_ChatboxHeight or Class15_BackHmMd20Height " +
	...
	/**
	 * This method could be the determining what do display
	 * in the chat box, such as the normal chat, 'enter ammount',
	 * 'enter name' etc.
	 * @param i
	 */
	public final void method18(int i) {
		Class15_Chatbox.method237();
		Class30_Sub2_Sub1_Sub3.anIntArray1472 = anIntArray1180;
		aClass30_Sub2_Sub1_Sub1_Chatback0.method348(0, 16083, 0);
		if(aBoolean1256) {
			aClass30_Sub2_Sub1_Sub4_1272.method381(0, aString1121, 23693, 40, 239);
			aClass30_Sub2_Sub1_Sub4_1272.method381(128, friendMsg + "*", 23693, 60, 239);
		} else if(queryId == 1) {
			aClass30_Sub2_Sub1_Sub4_1272.method381(0, "Enter amount:", 23693, 40, 239);
			aClass30_Sub2_Sub1_Sub4_1272.method381(128, queryResponse + "*", 23693, 60, 239);
		} else if(queryId == 2) {
			...
			Class30_Sub2_Sub1_Sub4 class30_sub2_sub1_sub4 = aClass30_Sub2_Sub1_Sub4_1271; //chat box?
			int j = 0;
			Class30_Sub2_Sub1.method333(Class15_ChatboxHeight-15, 0, Class15_ChatboxWidth - 16, 0); //chat history box
			for(int k = 0; k < 100; k++)
			{
				if(aStringArray944[k] != null)
				{
					...
					int i1 = (Class15_ChatboxHeight-19 - j * 14) + anInt1089; //start of chat history
					...
					if(l == 0)
					{
						if(i1 > 0 && i1 < Class15_ChatboxHeight+14)
					...
					if((l == 1 || l == 2) && (l == 1 || anInt1287 == 0 || anInt1287 == 1 && method109(false, s1)))
					{
						if(i1 > 0 && i1 < Class15_ChatboxHeight+14)
						{
							...
							if(byte0 == 1)
							{
								aClass30_Sub2_Sub1_Sub2_Modicons[0].method361(j1, 16083, i1 - 12);
								j1 += 14;
							}
							if(byte0 == 2)
							{
								aClass30_Sub2_Sub1_Sub2_Modicons[1].method361(j1, 16083, i1 - 12);
								j1 += 14;
							}
					...
					if((l == 3 || l == 7) && anInt1195 == 0 && (l == 7 || anInt845 == 0 || anInt845 == 1 && method109(false, s1)))
					{
						...
						{
							int k1 = 4;
							class30_sub2_sub1_sub4.method385(0x000000, "From", i1, 822, k1);
							k1 += class30_sub2_sub1_sub4.method383(anInt1116, "From ");
							if(byte0 == 1)
							{
								aClass30_Sub2_Sub1_Sub2_Modicons[0].method361(k1, 16083, i1 - 12);
								k1 += 14;
							}
							if(byte0 == 2)
							{
								aClass30_Sub2_Sub1_Sub2_Modicons[1].method361(k1, 16083, i1 - 12);
								k1 += 14;
							}
							class30_sub2_sub1_sub4.method385(0x000000, s1 + ":", i1, 822, k1);
					...
					if(l == 6 && anInt1195 == 0 && anInt845 < 2)
					{
						if(i1 > 0 && i1 < Class15_ChatboxHeight+14)
						{
							class30_sub2_sub1_sub4.method385(0x000000, "To " + s1 + ":", i1, 822, 4);
			...
			if(anInt1211 < 78)
				anInt1211 = 78;
			method30(519, Class15_ChatboxHeight-15, anInt1211 - anInt1089 - 77, 0, Class15_ChatboxWidth - 17, anInt1211+19+15); //chat scroll bar
			String s;
			if(aClass30_Sub2_Sub4_Sub1_Sub2_1126 != null && aClass30_Sub2_Sub4_Sub1_Sub2_1126.aString1703 != null)
				s = aClass30_Sub2_Sub4_Sub1_Sub2_1126.aString1703; //playername when typing in chat
			else
				s = Class50.method587(-45804, playerName);  //playername when not typing in chat
			class30_sub2_sub1_sub4.method385(0x000000, s + ":", Class15_ChatboxHeight-4, 822, 4);
			if (this.isTyping)
			{
				class30_sub2_sub1_sub4.method385(0x0000ff, playerMessage + "*", Class15_ChatboxHeight - 4, 822, 6 + class30_sub2_sub1_sub4.method383(anInt1116, s + ": "));
			}
			else
			{
				class30_sub2_sub1_sub4.method385(0x0000ff, "[Press Return to Chat]", Class15_ChatboxHeight - 4, 822, 6 + class30_sub2_sub1_sub4.method383(anInt1116, s + ": "));
			}
			Class30_Sub2_Sub1.ForegroundColorHoriz1(Class15_ChatboxHeight-16, 0, Class15_ChatboxWidth - 1, 0); //horixontal line in chat window
		}
		if(aBoolean885 && anInt948 == 2)
			method40((byte)9);
		Class15_ChatboxX = Class15_BackLeft20Width;
		Class15_ChatboxY = (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - Class15_Backbase10Height - Class15_ChatboxHeight;
		Class15_Chatbox.GraphicsPositioner(Class15_ChatboxY, super.graphics, Class15_ChatboxX); //chat box position
		Class15_GameWindow.method237();
	...
	public final void init()
	{
		try
		{
			...
			setserver("", "43594"); // ("", "43594")
			InitOpenClient(503, 765);
		}
	...
	public final Socket openSocket(int i)
			throws IOException {
		if(signlink.mainapp != null)
	...
	/**
	 * handles clicking upper sideicons
	 * @param i
	 */
	public final void method20(int i) {
		...
		int j = super.anInt26;
		if(anInt1136 == 1
				&& super.mousePressedX2 >= Class15_BackHmid10X
				&& super.mousePressedY2 >= Class15_BackHmid10Y
				&& super.mousePressedX2 <= Class15_BackHmid10X + Class15_BackHmid10Width
				&& super.mousePressedY2 <= Class15_BackHmid10Y + Class15_BackHmid10Height)
			j = 0;
		if(aBoolean885) {
			if(j != 1) {
				int k = super.mouseMovedX;
				int j1 = super.mouseMovedY;
				if(anInt948 == 0) { //game
					k -= Class15_GameWindowX;
					j1 -= Class15_GameWindowY;
				}
				if(anInt948 == 1) { //inventory
					k -= Class15_InvBack0X;
					j1 -= Class15_InvBack0Y;
				}
				if(anInt948 == 2) { //chat
					k -= Class15_ChatboxX;
					j1 -= Class15_ChatboxY;
			...
			if(j == 1) {
				...
				int k1 = anInt950;
				int i2 = anInt951;
				int k2 = super.mousePressedX2;
				int l2 = super.mousePressedY2;
				if(anInt948 == 0) {
					k2 -= Class15_GameWindowX;
					l2 -= Class15_GameWindowY;
				}
				if(anInt948 == 1) {
					k2 -= Class15_InvBack0X;
					l2 -= Class15_InvBack0Y;
				}
				if(anInt948 == 2) {
					k2 -= Class15_ChatboxX;
					l2 -= Class15_ChatboxY;
			...
			//System.out.println("x, y: "+super.mousePressedX2+" "+super.mousePressedY2);
			if(j == 1 && anInt1133 > 0) {
				...
				if(i1 == 632 || i1 == 78 || i1 == 867 || i1 == 431 || i1 == 53 || i1 == 74 || i1 == 454 || i1 == 539 || i1 == 493 || i1 == 847 || i1 == 447 || i1 == 1125) {
					...
					if(class9.aBoolean259 || class9.aBoolean235) {
						...
						anInt1085 = l1;
						anInt1086 = 2;
						anInt1087 = super.mousePressedX2;
						anInt1088 = super.mousePressedY2;
	...
	public final void method24(boolean flag, int i)
	{
		...
		for(int k2 = 0; k2 < 104; k2++)
		{
			...
			if(j3 >= 0)
			{
				...
				aClass30_Sub2_Sub1_Sub1Array1140[anInt1071] = aClass30_Sub2_Sub1_Sub1_Mapfunctions[j3];
	...
	public final void method29(int i, int j, Class9 class9, int k, int l, int i1, int j1) {
		if(class9.anInt262 != 0 || class9.anIntArray240 == null || class9.aBoolean266)
			return;
		if(k < i || i1 < l || k > i + class9.frameWidth || i1 > l + class9.frameHeight)
			return;
		int k1 = class9.anIntArray240.length;
		if(j != 13037)
			aClass19ArrayArrayArray827 = null;
		for(int l1 = 0; l1 < k1; l1++) {
			int i2 = class9.panelXOffset[l1] + i;
			int j2 = (class9.panelYOffset[l1] + l) - j1;
			Class9 class9_1 = Class9.aClass9Array210[class9.anIntArray240[l1]];
			i2 += class9_1.panelXOffsetExtra;
			j2 += class9_1.panelYOffsetExtra;
			if((class9_1.anInt230 >= 0 || class9_1.anInt216 != 0) && k >= i2 && i1 >= j2 && k < i2 + class9_1.frameWidth && i1 < j2 + class9_1.frameHeight)
			...
			if(class9_1.anInt262 == 0) {
				...
				if(class9_1.anInt261 > class9_1.frameHeight)
					method65(i2 + class9_1.frameWidth, class9_1.frameHeight, k, i1, class9_1, j2, true, class9_1.anInt261, 0);
			} else {
				if(class9_1.anInt217 == 1 && k >= i2 && i1 >= j2 && k < i2 + class9_1.frameWidth && i1 < j2 + class9_1.frameHeight) {
					boolean flag = false;
				...
				if(class9_1.anInt217 == 2 && anInt1136 == 0 && k >= i2 && i1 >= j2 && k < i2 + class9_1.frameWidth && i1 < j2 + class9_1.frameHeight) {
				...
				if(class9_1.anInt217 == 3 && k >= i2 && i1 >= j2 && k < i2 + class9_1.frameWidth && i1 < j2 + class9_1.frameHeight) {
					aStringArray1199[anInt1133] = "Close";
					anIntArray1093[anInt1133] = 200;
					anIntArray1092[anInt1133] = class9_1.anInt250;
					anInt1133++;
				}
				if(class9_1.anInt217 == 4 && k >= i2 && i1 >= j2 && k < i2 + class9_1.frameWidth && i1 < j2 + class9_1.frameHeight) {
					aStringArray1199[anInt1133] = class9_1.aString221;
					anIntArray1093[anInt1133] = 169;
					anIntArray1092[anInt1133] = class9_1.anInt250;
					anInt1133++;
				}
				if(class9_1.anInt217 == 5 && k >= i2 && i1 >= j2 && k < i2 + class9_1.frameWidth && i1 < j2 + class9_1.frameHeight) {
					aStringArray1199[anInt1133] = class9_1.aString221;
					anIntArray1093[anInt1133] = 646;
					anIntArray1092[anInt1133] = class9_1.anInt250;
					anInt1133++;
				}
				if(class9_1.anInt217 == 6 && !aBoolean1149 && k >= i2 && i1 >= j2 && k < i2 + class9_1.frameWidth && i1 < j2 + class9_1.frameHeight) {
					aStringArray1199[anInt1133] = class9_1.aString221;
				...
				if(class9_1.anInt262 == 2) {
					int k2 = 0;
					for(int l2 = 0; l2 < class9_1.frameHeight; l2++) {
						for(int i3 = 0; i3 < class9_1.frameWidth; i3++) {
	...
	public final void method30(int i, int yLength, int slidePosition, int yPos, int xPos, int j1) {
		aClass30_Sub2_Sub1_Sub1_Scrollbar0.method348(xPos, 16083, yPos); //upper scrollbar arrow
		aClass30_Sub2_Sub1_Sub1_Scrollbar1.method348(xPos, 16083, (yPos + yLength) - 16); //lower scrollbar arrow
		Class30_Sub2_Sub1.BackgroundColor1(yLength - 32, yPos + 16, xPos, 0x000001, 16);
		Class30_Sub2_Sub1.BackgroundColor1(yLength - 32, yPos + 16, xPos, 0x3d3426, 15);
		Class30_Sub2_Sub1.BackgroundColor1(yLength - 32, yPos + 16, xPos, 0x342d21, 13);
		Class30_Sub2_Sub1.BackgroundColor1(yLength - 32, yPos + 16, xPos, 0x2e281d, 11);
		Class30_Sub2_Sub1.BackgroundColor1(yLength - 32, yPos + 16, xPos, 0x29241b, 10);
		Class30_Sub2_Sub1.BackgroundColor1(yLength - 32, yPos + 16, xPos, 0x252019, 9);
		Class30_Sub2_Sub1.BackgroundColor1(yLength - 32, yPos + 16, xPos, 0x000001, 1);
		int k1 = ((yLength - 32) * yLength) / j1;
		if(k1 < 8)
			k1 = 8;
		int l1 = ((yLength - 32 - k1) * slidePosition) / (j1 - yLength);
		Class30_Sub2_Sub1.BackgroundColor1(k1, yPos + 16 + l1, xPos, anInt1063, 16);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x000001, k1, xPos, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x817051, k1, xPos + 1, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x73654a, k1, xPos + 2, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x6a5c43, k1, xPos + 3, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x6a5c43, k1, xPos + 4, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x655841, k1, xPos + 5, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x655841, k1, xPos + 6, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x61553e, k1, xPos + 7, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x61553e, k1, xPos + 8, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x5d513c, k1, xPos + 9, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x5d513c, k1, xPos + 10, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x594e3a, k1, xPos + 11, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x594e3a, k1, xPos + 12, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x514635, k1, xPos + 13, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x4b4131, k1, xPos + 14, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 16 + l1, 0x000001, 15, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x000001, 15, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x655841, 14, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x6a5c43, 13, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x6d5f48, 11, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x73654a, 10, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x76684b, 7, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x7b6a4d, 5, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x7e6e50, 4, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x817051, 3, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 17 + l1, 0x000001, 2, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x000001, 16, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x564b38, 15, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x5d513c, 14, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x625640, 11, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x655841, 10, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x6a5c43, 7, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x6e6046, 5, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x716247, 4, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x7b6a4d, 3, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x817051, 2, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 18 + l1, 0x000001, 1, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x000001, 16, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x514635, 15, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x564b38, 14, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x5d513c, 11, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x61553e, 9, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x655841, 7, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x6a5c43, 5, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x6e6046, 4, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x73654a, 3, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x817051, 2, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 19 + l1, 0x000001, 1, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x000001, 16, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x4b4131, 15, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x544936, 14, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x594e3a, 13, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x5d513c, 10, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x61553e, 8, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x655841, 6, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x6a5c43, 4, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x73654a, 3, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x817051, 2, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 20 + l1, 0x000001, 1, xPos);
		if(i <= 0)
			anInt1105 = aClass17_1000.method246();
		Class30_Sub2_Sub1.ForegroundColorVert1(yPos + 16 + l1, 0x000001, k1, xPos + 15, anInt1135);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 15 + l1 + k1, 0x000001, 16, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 14 + l1 + k1, 0x000001, 15, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 14 + l1 + k1, 0x3f372a, 14, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 14 + l1 + k1, 0x443c2d, 10, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 14 + l1 + k1, 0x483e2f, 9, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 14 + l1 + k1, 0x4a402f, 7, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 14 + l1 + k1, 0x4b4131, 4, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 14 + l1 + k1, 0x564b38, 3, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 14 + l1 + k1, 0x000001, 2, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x000001, 16, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x443c2d, 15, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x4b4131, 11, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x514635, 9, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x544936, 7, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x564b38, 6, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x594e3a, 4, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x625640, 3, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x6a5c43, 2, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 13 + l1 + k1, 0x000001, 1, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x000001, 16, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x443c2d, 15, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x4b4131, 14, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x544936, 12, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x564b38, 11, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x594e3a, 10, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x5d513c, 7, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x61553e, 4, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x6e6046, 3, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x7b6a4d, 2, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 12 + l1 + k1, 0x000001, 1, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x000001, 16, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x4b4131, 15, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x514635, 14, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x564b38, 13, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x594e3a, 11, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x5d513c, 9, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x61553e, 7, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x655841, 5, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x6a5c43, 4, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x73654a, 3, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x7b6a4d, 2, xPos);
		Class30_Sub2_Sub1.ForegroundColorHoriz1(yPos + 11 + l1 + k1, 0x000001, 1, xPos);
	}
	...
	private final void method31(Class30_Sub2_Sub2 class30_sub2_sub2, int i, int j)
	{
		...
		{
			signlink.reporterror(playerName + " size mismatch in getnpcpos - pos:" + class30_sub2_sub2.anInt1406 + " psize:" + i);
			throw new RuntimeException("eek");
		}
		for(int i1 = 0; i1 < anInt836; i1++)
			if(aClass30_Sub2_Sub4_Sub1_Sub1Array835[anIntArray837[i1]] == null)
			{
				signlink.reporterror(playerName + " null entry in npc list - pos:" + i1 + " size:" + anInt836);
				throw new RuntimeException("eek");
			}

	}
	/**
	 * Clicking BACKBASE1 0 buttons
	 * @param flag
	 */
	public final void method32(boolean flag) {
		aBoolean1157 &= flag;
		if(super.anInt26 == 1) {
			//System.out.println("method32: "+super.mousePressedX2+" : "+super.mousePressedY2);
			if(super.mousePressedX2 >= Class15_Backbase10X + 6
					&& super.mousePressedX2 <= Class15_Backbase10X + 106
					&& super.mousePressedY2 >= Class15_Backbase10Y + 8
					&& super.mousePressedY2 <= Class15_Backbase10Y + Class15_Backbase10Height - 1) {
			...
			if(super.mousePressedX2 >= Class15_Backbase10X + 135
					&& super.mousePressedX2 <= Class15_Backbase10X + 235
					&& super.mousePressedY2 >= Class15_Backbase10Y + 8
					&& super.mousePressedY2 <= Class15_Backbase10Y + Class15_Backbase10Height - 1) {
			...
			if(super.mousePressedX2 >= Class15_Backbase10X + 273
					&& super.mousePressedX2 <= Class15_Backbase10X + 373
					&& super.mousePressedY2 >= Class15_Backbase10Y + 8 
					&& super.mousePressedY2 <= Class15_Backbase10Y + Class15_Backbase10Height - 1) {
			...
			if(super.mousePressedX2 >= Class15_Backbase10X + 412
					&& super.mousePressedX2 <= Class15_Backbase10X + 512
					&& super.mousePressedY2 >= Class15_Backbase10Y + 8
					&& super.mousePressedY2 <= Class15_Backbase10Y + Class15_Backbase10Height - 1)
			{
				if(anInt857 == -1) {
	...
	public final void method34(int i) {
		...
		for(int j = -1; j < anInt891 + anInt836; j++) {
			...
			if(j < anInt891)
			{
				...
				if(class30_sub2_sub4_sub1_sub2.anInt1706 != 0)
				{
					...
					if(anInt963 > -1)
					{
						for(int i2 = 0; i2 < 8; i2++)
							...
							{
								aClass30_Sub2_Sub1_Sub1_Headicons_prayer[i2].method348(anInt963 - 12, 16083, anInt964 - l); //position of headicon above player
								l += 25;
							}
				...
				if(j >= 0 && anInt855 == 10 && anInt933 == anIntArray892[j])
				{
					try {
						method127(true, ((Class30_Sub2_Sub4_Sub1) (obj)), ((Class30_Sub2_Sub4_Sub1) (obj)).anInt1507 + 15);
						if(anInt963 > -1)
							aClass30_Sub2_Sub1_Sub1_Headicons_prayer[7].method348(anInt963 - 12, 16083, anInt964 - l);
					}
					catch (Exception e) {
						e.printStackTrace();
					}
			...
			} else
			{
				...
				if(class5_1.anInt75 >= 0 && class5_1.anInt75 < aClass30_Sub2_Sub1_Sub1_Headicons_prayer.length)
				{
					method127(true, ((Class30_Sub2_Sub4_Sub1) (obj)), ((Class30_Sub2_Sub4_Sub1) (obj)).anInt1507 + 15);
					if(anInt963 > -1)
						aClass30_Sub2_Sub1_Sub1_Headicons_prayer[class5_1.anInt75].method348(anInt963 - 12, 16083, anInt964 - 30);
				}
				if(anInt855 == 1 && anInt1222 == anIntArray837[j - anInt891] && anInt1161 % 20 < 10)
				{
					method127(true, ((Class30_Sub2_Sub4_Sub1) (obj)), ((Class30_Sub2_Sub4_Sub1) (obj)).anInt1507 + 15);
					if(anInt963 > -1)
						aClass30_Sub2_Sub1_Sub1_Headicons_prayer[2].method348(anInt963 - 12, 16083, anInt964 - 28);
				}
			}
			...
			if(((Class30_Sub2_Sub4_Sub1) (obj)).anInt1532 > anInt1161)
			{
				...
				if(anInt963 > -1)
				{
					try {
						...
						if(i1 > 30)
							i1 = 30;
						Class30_Sub2_Sub1.BackgroundColor1(5, anInt964 - 3, anInt963 - 15, 65280, i1);
						Class30_Sub2_Sub1.BackgroundColor1(5, anInt964 - 3, (anInt963 - 15) + i1, 0xff0000, 30 - i1);
					}
					catch (Exception e) {
						e.printStackTrace();
					}
			...
			for(int j1 = 0; j1 < 4; j1++)
				if(((Class30_Sub2_Sub4_Sub1) (obj)).anIntArray1516[j1] > anInt1161) {
					...
					if(anInt963 > -1) {
						...
						aClass30_Sub2_Sub1_Sub1_Hitmarks[((Class30_Sub2_Sub4_Sub1) (obj)).anIntArray1515[j1]].method348(anInt963 - 12, 16083, anInt964 - 12);
					...
					if(anIntArray980[k] == 7)
						...
						if(anIntArray980[k] == 8)
							...
							if(anIntArray981[k] == 4) {
								...
								Class30_Sub2_Sub1.method333(334, anInt963 - 50, anInt963 + 50, 0); //334 related to GameWindow Width?
	...
	public final void method36(byte byte0) {
		Class15_InvBack0.method237();
		Class30_Sub2_Sub1_Sub3.anIntArray1472 = anIntArray1181;
		if(byte0 != -81)
			return;
		aClass30_Sub2_Sub1_Sub1_Invback0.method348(0, 16083, 0);
		if(anInt1189 != -1)
			method105(8, 0, 0, Class9.aClass9Array210[anInt1189], 0);
		else
			if(anIntArray1130[anInt1221] != -1)
				method105(8, 0, 0, Class9.aClass9Array210[anIntArray1130[anInt1221]], 0); //displays the correct sidicon menu
		if(aBoolean885 && anInt948 == 1)
			method40((byte)9);
		Class15_InvBack0X = (gFrame.getWidth() - 2*EGUI.translateGameX) - Class15_backRight20Width - Class15_InvBack0Width;
		Class15_InvBack0Y = (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - Class15_Backbase20Height - Class15_InvBack0Height;
		Class15_InvBack0.GraphicsPositioner(Class15_InvBack0Y, super.graphics, Class15_InvBack0X);
		Class15_GameWindow.method237();
		Class30_Sub2_Sub1_Sub3.anIntArray1472 = anIntArray1182;
	}
	...
	public final void method37(int i, int j)
	{
		...
		if(!aBoolean960)
		{
			if(Class30_Sub2_Sub1_Sub3.anIntArray1480[17] >= j)
			{
				...
				int k = class30_sub2_sub1_sub2.imageWidth * class30_sub2_sub1_sub2.imageHeight - 1;
				int j1 = class30_sub2_sub1_sub2.imageWidth * anInt945 * 2;
				byte abyte0[] = class30_sub2_sub1_sub2.imageArray;
				byte abyte3[] = aByteArray912;
				for(int i2 = 0; i2 <= k; i2++)
					abyte3[i2] = abyte0[i2 - j1 & k];

				class30_sub2_sub1_sub2.imageArray = abyte3;
			...
			if(Class30_Sub2_Sub1_Sub3.anIntArray1480[24] >= j)
			{
				...
				int l = class30_sub2_sub1_sub2_1.imageWidth * class30_sub2_sub1_sub2_1.imageHeight - 1;
				int k1 = class30_sub2_sub1_sub2_1.imageWidth * anInt945 * 2;
				byte abyte1[] = class30_sub2_sub1_sub2_1.imageArray;
				byte abyte4[] = aByteArray912;
				for(int j2 = 0; j2 <= l; j2++)
					abyte4[j2] = abyte1[j2 - k1 & l];

				class30_sub2_sub1_sub2_1.imageArray = abyte4;
			...
			if(Class30_Sub2_Sub1_Sub3.anIntArray1480[34] >= j)
			{
				...
				int i1 = class30_sub2_sub1_sub2_2.imageWidth * class30_sub2_sub1_sub2_2.imageHeight - 1;
				int l1 = class30_sub2_sub1_sub2_2.imageWidth * anInt945 * 2;
				byte abyte2[] = class30_sub2_sub1_sub2_2.imageArray;
				byte abyte5[] = aByteArray912;
				for(int k2 = 0; k2 <= i1; k2++)
					abyte5[k2] = abyte2[k2 - l1 & i1];

				class30_sub2_sub1_sub2_2.imageArray = abyte5;
	...
	public final void method40(byte byte0)
	{
		...
		int l = anInt952;
		int i1 = 0x5d5447;
		Class30_Sub2_Sub1.BackgroundColor1(l, j, i, i1, k);
		if(byte0 == 9)
			byte0 = 0;
		else
			return;
		Class30_Sub2_Sub1.BackgroundColor1(16, j + 1, i + 1, 0, k - 2);
		Class30_Sub2_Sub1.BorderColor1(i + 1, k - 2, l - 19, 0, j + 18);
		aClass30_Sub2_Sub1_Sub4_1272.method385(i1, "Choose Option", j + 14, 822, i + 3);
		int j1 = super.mouseMovedX;
		int k1 = super.mouseMovedY;
		if(anInt948 == 0)
		{
			j1 -= Class15_GameWindowX;
			k1 -= Class15_GameWindowY;
		}
		if(anInt948 == 1)
		{
			j1 -= Class15_InvBack0X;
			k1 -= Class15_InvBack0Y;
		}
		if(anInt948 == 2)
		{
			j1 -= Class15_ChatboxX;
	...
	public final boolean method48(int i, Class9 class9)
	{
		...
		{
			method147(537);
			if(reportPlayerName.length() > 0)
			{
				aClass30_Sub2_Sub2_1192.method397((byte)6, 218);
				aClass30_Sub2_Sub2_1192.method404(5, Class50.stringToLong(reportPlayerName));
	...
	public final void method50(int i, int j, int k, int l, int i1, int j1)
	{
		...
		{
			Class30_Sub2_Sub1_Sub2 class30_sub2_sub1_sub2_2 = aClass30_Sub2_Sub1_Sub2_Mapscenes[class46_2.anInt758];
			if(class30_sub2_sub1_sub2_2 != null)
			{
				int i6 = (class46_2.anInt744 * 4 - class30_sub2_sub1_sub2_2.imageWidth) / 2;
				int j6 = (class46_2.anInt761 * 4 - class30_sub2_sub1_sub2_2.imageHeight) / 2;
		...
		int l3 = k1 >> 14 & 0x7fff;
				...
				{
					Class30_Sub2_Sub1_Sub2 class30_sub2_sub1_sub2_1 = aClass30_Sub2_Sub1_Sub2_Mapscenes[class46_1.anInt758];
					if(class30_sub2_sub1_sub2_1 != null)
					{
						int j5 = (class46_1.anInt744 * 4 - class30_sub2_sub1_sub2_1.imageWidth) / 2;
						int k5 = (class46_1.anInt761 * 4 - class30_sub2_sub1_sub2_1.imageHeight) / 2;
		...
		{
			Class30_Sub2_Sub1_Sub2 class30_sub2_sub1_sub2 = aClass30_Sub2_Sub1_Sub2_Mapscenes[class46.anInt758];
			if(class30_sub2_sub1_sub2 != null)
			{
				int i4 = (class46.anInt744 * 4 - class30_sub2_sub1_sub2.imageWidth) / 2;
				int j4 = (class46.anInt761 * 4 - class30_sub2_sub1_sub2.imageHeight) / 2;
	...
	{
		/*delays painting of black background on loginscreen */
		graphics.setColor(Color.black);
		graphics.fillRect(0, 0, (gFrame.getWidth() - 2*EGUI.translateGameX), (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX));
		...
		try
		{
			...
			System.err.println("error loading fl_icon");
		}
		if(j == 0)
		{
			for(int k = 0; k < 12; k++)
		...
		/* burning braziers on login screen */
		for(int i1 = 0; i1 < 33920; i1++)
		{
			aClass30_Sub2_Sub1_Sub1_1201.anIntArray1439[i1] = Class15_LoginLeftGobFire.imagePixelsArray[i1];
			aClass30_Sub2_Sub1_Sub1_1202.anIntArray1439[i1] = Class15_LoginRightGobFire.imagePixelsArray[i1];
		}
		/* */
		...
		{
			anIntArray851[i1] = i1 * 0x40000;
			anIntArray852[i1] = i1 * 0x400;
			anIntArray853[i1] = i1 * 0x4;
			anIntArray851[i1 + 64] = 0xff0000 + 0x400 * i1;
			anIntArray852[i1 + 64] = 0x00ff00 + 0x4 * i1;
			anIntArray853[i1 + 64] = 0x0000ff + 0x40000 * i1;
			anIntArray851[i1 + 128] = 0xffff00 + 0x4 * i1;
			anIntArray852[i1 + 128] = 0x00ffff + 0x40000 * i1;
			anIntArray853[i1 + 128] = 0xff00ff + 0x400 * i1;
			anIntArray851[i1 + 192] = 0xffffff;
			anIntArray852[i1 + 192] = 0xffffff;
			anIntArray853[i1 + 192] = 0xffffff;
		}
	...
	public static final void main(String args[])
	{
		...
		{
			nodeID = 0; //node-id
			portOffset = 0; //port-offset
			method52(false);//highmem
			isMember = true;//members
			signlink.storeid = 32; //storeid
			signlink.startpriv(InetAddress.getLocalHost());
			client client1 = new client();
			Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
			client1.OpenClient((int)d.getHeight(), (int)d.getWidth());
			//client1.OpenClient(503+150, 765+300);
			setserver(args[0], "55555"); //43594
			return;
		}
		catch(Exception exception)
		{
	...
	public final void method53(int i)
	{
		...
		{
			Class15_GameWindow.method237();
			aClass30_Sub2_Sub1_Sub4_1271.method381(0x000000, "Loading - please wait.", 23693, Class15_GameWindowHeight/2 - 16, Class15_GameWindowWidth/2 + 1);
			aClass30_Sub2_Sub1_Sub4_1271.method381(0xffffff, "Loading - please wait.", 23693, Class15_GameWindowHeight/2 - 17, Class15_GameWindowWidth/2);
			Class15_GameWindow.GraphicsPositioner(Class15_GameWindowY, super.graphics, Class15_GameWindowX);
			anInt1023 = 1;
		...
		if(anInt1023 == 1)
		{
			...
			{
				signlink.reporterror(playerName + " glcfb " + aLong1215 + "," + j + "," + aBoolean960 + "," + aClass14Array970[0] + "," + aClass42_Sub1_1068.method552() + "," + anInt918 + "," + anInt1069 + "," + anInt1070);
				aLong824 = System.currentTimeMillis();
			}
		}
	...
	/**
	 * handles animation of login fires
	 * @param i
	 */
	...
	public final void method62(int i)
	{
		...
		if(super.anInt26 != 0)
		{
			...
			int k2 = super.mousePressedY2;
			if(k2 < 0)
				k2 = 0;
			else
				if(k2 > (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - 1)
					k2 = (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - 1;
			int k3 = super.mousePressedX2;
			if(k3 < 0)
				k3 = 0;
			else
				if(k3 > (gFrame.getWidth() - 2*EGUI.translateGameX) - 1)
					k3 = (gFrame.getWidth() - 2*EGUI.translateGameX) - 1;
			int k4 = k2 * (gFrame.getWidth() - 2*EGUI.translateGameX) + k3;
			int j5 = 0;
			if(super.anInt26 == 2)
				j5 = 1;
			int l5 = (int)l;
		...
		if(anInt1016 > 0)
			anInt1016--;
		if(super.keyDown[1] == 1 || super.keyDown[2] == 1 || super.keyDown[3] == 1 || super.keyDown[4] == 1)
			aBoolean1017 = true;
		...
		{
			anInt989++;
			if(super.mouseMovedX > anInt1087 + 50 || super.mouseMovedX < anInt1087 - 50 || super.mouseMovedY > anInt1088 + 50 || super.mouseMovedY < anInt1088 - 50)
				aBoolean1242 = true;
			if(super.anInt19 == 0)
			{
				if(anInt1086 == 2)
		...
		if(Class25.anInt470 != -1)
		{
			...
			if(flag)
			{
				anInt914 = super.mousePressedX2;
				anInt915 = super.mousePressedY2;
				anInt917 = 1;
				anInt916 = 0;
			}
		}
		...
		try
		{
			...
			{
				aClass24_1168.method271(aClass30_Sub2_Sub2_1192.anInt1406, 0, aClass30_Sub2_Sub2_1192.cacheData, 0);
	...
	{
		notInLoginScreen = false;
		if(Class15_LoginUpperArc != null)
			return;
		super.aClass15_13 = null;
		Class15_Chatbox = null;
		Class15_Mapback01 = null;
		Class15_InvBack0 = null;
		Class15_GameWindow = null;
		Class15_Backbase10 = null;
		Class15_Backbase20 = null;
		Class15_BackHmid10 = null;
		Class15_LoginLeftGobFireHeight = 265;
		Class15_LoginLeftGobFireWidth = 128;
		Class15_LoginLeftGobFire = new Class15(Class15_LoginLeftGobFireWidth, Class15_LoginLeftGobFireHeight, getFrameComponent(0));
		Class30_Sub2_Sub1.ResetPixelArray();
		Class15_LoginRightGobFireHeight = 265;
		Class15_LoginRightGobFireWidth = 128;
		Class15_LoginRightGobFire = new Class15(Class15_LoginRightGobFireWidth, Class15_LoginRightGobFireHeight, getFrameComponent(0));
		Class30_Sub2_Sub1.ResetPixelArray();
		Class15_LoginUpperArcHeight = 171;
		Class15_LoginUpperArcWidth = 509;
		Class15_LoginUpperArc = new Class15(Class15_LoginUpperArcWidth, Class15_LoginUpperArcHeight, getFrameComponent(0));
		Class30_Sub2_Sub1.ResetPixelArray();
		Class15_LoginLowerArcHeight = 132;
		Class15_LoginLowerArcWidth = 360;
		Class15_LoginLowerArc = new Class15(Class15_LoginLowerArcWidth, Class15_LoginLowerArcHeight, getFrameComponent(0));
		Class30_Sub2_Sub1.ResetPixelArray();
		Class15_LoginMiddleArcHeight = 200;
		Class15_LoginMiddleArcWidth = 360;
		Class15_LoginMiddleArc = new Class15(Class15_LoginMiddleArcWidth, Class15_LoginMiddleArcHeight, getFrameComponent(0));
		Class30_Sub2_Sub1.ResetPixelArray();
		Class15_LoginLeftGobletHeight = 238;
		Class15_LoginLeftGobletWidth = 202;
		Class15_LoginLeftGoblet = new Class15(Class15_LoginLeftGobletWidth, Class15_LoginLeftGobletHeight, getFrameComponent(0));
		if(i < 0 || i > 0)
			aClass19ArrayArrayArray827 = null;
		Class30_Sub2_Sub1.ResetPixelArray();
		Class15_LoginRightGobletHeight = 238;
		Class15_LoginRightGobletWidth = 203;
		Class15_LoginRightGoblet = new Class15(Class15_LoginRightGobletWidth, Class15_LoginRightGobletHeight, getFrameComponent(0));
		Class30_Sub2_Sub1.ResetPixelArray();
		Class15_LeftLeftoverHeight = 94;
		Class15_LeftLeftoverWidth = 74;
		Class15_LeftLeftover = new Class15(Class15_LeftLeftoverWidth, Class15_LeftLeftoverHeight, getFrameComponent(0));
		Class30_Sub2_Sub1.ResetPixelArray();
		Class15_RightLeftoverHeight = 94;
		Class15_RightLeftoverWidth = 75;
		Class15_RightLeftover = new Class15(Class15_RightLeftoverWidth, Class15_RightLeftoverHeight, getFrameComponent(0));
		Class30_Sub2_Sub1.ResetPixelArray();
	...
	public final void method13(int loadPercentWhenDone, byte byte0, String s)
	{
		/* if we want to see the loading process clearly
		System.out.println(loadPercentWhenDone);
		try
		{
			Thread.sleep(2000);
		} catch(Exception e) {}
		 */
		anInt1079 = loadPercentWhenDone; // how many percent
		aString1049 = s;
		method64(0);
		if(aClass44_1053 == null)
		{
			super.method13(loadPercentWhenDone, s);
			return;
		}
		Class15_LoginMiddleArc.method237();
		int c = '\u0168'; //360
		...
		int j = c1 / 2 - 18 - byte1;
		// Colours
		Class30_Sub2_Sub1.BorderColor1(c / 2 - 152, 304, 34, 0x8c1111, j);
		Class30_Sub2_Sub1.BorderColor1(c / 2 - 151, 302, 32, 0, j + 1);
		Class30_Sub2_Sub1.BackgroundColor1(30, j + 2, c / 2 - 150, 0x8c1111, loadPercentWhenDone * 3);
		Class30_Sub2_Sub1.BackgroundColor1(30, j + 2, (c / 2 - 150) + loadPercentWhenDone * 3, 0, 300 - loadPercentWhenDone * 3);
		aClass30_Sub2_Sub1_Sub4_1272.method381(0xffffff, s, 23693, (c1 / 2 + 5) - byte1, c / 2);
		Class15_LoginMiddleArcX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 202;
		Class15_LoginMiddleArcY = 171;
		Class15_LoginMiddleArc.GraphicsPositioner(Class15_LoginMiddleArcY, super.graphics, Class15_LoginMiddleArcX);
		if(byte0 != 4) {
			for(int k = 1; k > 0; k++);
		}
		if(aBoolean1255) {
			aBoolean1255 = false;
			if(!aBoolean831) {
				Class15_LoginLeftGobFireX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 0;
				Class15_LoginRightGobFireY = 0;
				Class15_LoginLeftGobFire.GraphicsPositioner(Class15_LoginRightGobFireY, super.graphics, Class15_LoginLeftGobFireX);
				Class15_LoginRightGobFireX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 637;
				Class15_LoginRightGobFireY = 0;
				Class15_LoginRightGobFire.GraphicsPositioner(Class15_LoginRightGobFireY, super.graphics, Class15_LoginRightGobFireX);
			}
			Class15_LoginUpperArcX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 128;
			Class15_LoginUpperArcY = 0;
			Class15_LoginUpperArc.GraphicsPositioner(Class15_LoginUpperArcY, super.graphics, Class15_LoginUpperArcX);
			Class15_LoginLowerArcX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 202;
			Class15_LoginLowerArcY = 371;
			Class15_LoginLowerArc.GraphicsPositioner(Class15_LoginLowerArcY, super.graphics, Class15_LoginLowerArcX);
			Class15_LoginLeftGobletX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 0;
			Class15_LoginLeftGobletY = 265;
			Class15_LoginLeftGoblet.GraphicsPositioner(Class15_LoginLeftGobletY, super.graphics, Class15_LoginLeftGobletX);
			Class15_LoginRightGobletX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 562;
			Class15_LoginRightGobletY = 265;
			Class15_LoginRightGoblet.GraphicsPositioner(Class15_LoginRightGobletY, super.graphics, Class15_LoginRightGobletX);
			Class15_LeftLeftoverX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 128;
			Class15_LeftLeftoverY = 171;
			Class15_LeftLeftover.GraphicsPositioner(Class15_LeftLeftoverY, super.graphics, Class15_LeftLeftoverX);
			Class15_RightLeftoverX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 562;
			Class15_RightLeftoverY = 171;
			Class15_RightLeftover.GraphicsPositioner(Class15_RightLeftoverY, super.graphics, Class15_RightLeftoverX);
		}
	}
	...
	public final void method68(int i)
	{
		...
		Class15_GameWindow.method237();
		aClass30_Sub2_Sub1_Sub4_1271.method381(0, "Connection lost", 23693, Class15_GameWindowHeight/2 - 23, Class15_GameWindowWidth/2 + 1);
		aClass30_Sub2_Sub1_Sub4_1271.method381(0xffffff, "Connection lost", 23693, Class15_GameWindowHeight/2 - 24, Class15_GameWindowWidth/2);
		aClass30_Sub2_Sub1_Sub4_1271.method381(0, "Please wait - attempting to reestablish", 23693, Class15_GameWindowHeight/2 - 8, Class15_GameWindowWidth/2 + 1);
		aClass30_Sub2_Sub1_Sub4_1271.method381(0xffffff, "Please wait - attempting to reestablish", 23693, Class15_GameWindowHeight/2 - 9, Class15_GameWindowWidth/2);
		while(i >= 0)
		...
		aBoolean1157 = false;
		anInt1038 = 0;
		tryLogin(playerName, playerPass, true);
		if(!aBoolean1157)
			method44(true);
		try
		{
	...
	/**
	 * handeling packets.
	 * showpackets = 1 will print the packet id
	 * @param i
	 * @param flag
	 */
	public final void method69(int i, boolean flag)
	{
		...
		int i1 = anIntArray1094[i]; //item ids?
		/*
		for(int asd = 0;asd < anIntArray1094.length; asd++)
		{
			if(anIntArray1091[asd] != 0)
				System.out.println("anIntArray1091: "+anIntArray1091[asd]+", idx: "+asd);
			if(anIntArray1092[asd] != 0)
				System.out.println("anIntArray1092: "+anIntArray1092[asd]+", idx: "+asd);
			if(anIntArray1093[asd] != 0)
				System.out.println("anIntArray1093: "+anIntArray1093[asd]+", idx: "+asd);
			if(anIntArray1094[asd] != 0)
				System.out.println("anIntArray1094: "+anIntArray1094[asd]+", idx: "+asd);
		}
		 */
		if(l >= 2000)
			l -= 2000;
		...
		{
			/*
			 * the -4 might be because we have translated the gamewindow
			 * 4 pixels in x and y, but changing these does not seem to
			 * have any effect when clicking in interfaces (l==516)
			 */
			if(!aBoolean885)
				aClass25_946.method312(false, super.mousePressedY2 - 4, super.mousePressedX2 - 4);
			else
		...
		if(l == 337 || l == 42 || l == 792 || l == 322)
		{
			...
			if(k1 != -1)
			{
				long l3 = Class50.stringToLong(s.substring(k1 + 5).trim());
				if(l == 337)
					method41((byte)68, l3);
				if(l == 42)
					method113(l3, 4);
		...
		if(l == 484 || l == 6)
		{
			...
			if(l1 != -1)
			{
				...
				String s7 = Class50.method587(-45804, Class50.method584(Class50.stringToLong(s1), (byte)-99));
				boolean flag9 = false;
		...
		if(l == 606)
		{
			...
			if(j2 != -1)
				...
				{
					method147(537);
					reportPlayerName = s2.substring(j2 + 5).trim();
					aBoolean1158 = false;
		...
		if(l == 639)
		{
			...
			if(k2 != -1)
			{
				long l4 = Class50.stringToLong(s3.substring(k2 + 5).trim());
				int k3 = -1;
		...
		if(l == 454)
		{ //equipping items?
			System.out.println("new item: "+i+", old item: "+k+" itemID: "+i1);
			aClass30_Sub2_Sub2_1192.method397((byte)6, 41);
			aClass30_Sub2_Sub2_1192.method399(i1); //itemID
			aClass30_Sub2_Sub2_1192.method432(-431, j); //new item?
			aClass30_Sub2_Sub2_1192.method432(-431, k); // old item?
			anInt1243 = 0;
			anInt1244 = k;
			anInt1245 = j;
			anInt1246 = 2;
		...
		{ //prayers
			aClass30_Sub2_Sub2_1192.method397((byte)6, 185);
			aClass30_Sub2_Sub2_1192.method399(k); //headicon
			...
			if(class9_3.anIntArrayArray226 != null && class9_3.anIntArrayArray226[0][0] == 5)
			{
				...
				// anIntArray971[l2] = 1 - anIntArray971[l2]; //toggles activation of prayer in prayer tab
				/*
				 * The following method is a fix for prayer
				 * off: anIntArray971[l2] = 0
				 * on: anIntArray971[l2] = 1
				 */
				if(anIntArray971[l2] == 0)
				{ //clicked prayer is off
					switch(l2)
					{
					case 83: //Thick Skin
						anIntArray971[83] = 1;
						...
						anIntArray971[92] = 0;
						break;
					case 84: //Burst of Strength
						anIntArray971[84] = 1;
						anIntArray971[87] = 0;
						anIntArray971[93] = 0;
						break;
					case 85: //Clarity of Thought
						anIntArray971[85] = 1;
						anIntArray971[88] = 0;
						anIntArray971[94] = 0;
						break;
					case 86: //Rock Skin
						...
						anIntArray971[92] = 0;
						break;
					case 87: //Superhuman Strength
						anIntArray971[84] = 0;
						anIntArray971[87] = 1;
						anIntArray971[93] = 0;
						break;
					case 88: //Improved Reflexes
						anIntArray971[85] = 0;
						anIntArray971[88] = 1;
						anIntArray971[94] = 0;
						break;
					case 89: //Rapid Restore
						anIntArray971[89] = 1;
						anIntArray971[90] = 0;
						anIntArray971[99] = 0;
						break;
					...
					case 92: //Steel skin
						...
						anIntArray971[92] = 1;
						break;
					case 93: //Ultimate Strength
						anIntArray971[84] = 0;
						anIntArray971[87] = 0;
						anIntArray971[93] = 1;
						break;
					case 94: //Incredible Reflexes
						anIntArray971[85] = 0;
						anIntArray971[88] = 0;
						anIntArray971[94] = 1;
						break;
					case 95: //Protect from Magic
						anIntArray971[95] = 1; //Protect from Magic
						anIntArray971[96] = 0; //Protect from Missiles
						anIntArray971[97] = 0; //Protect from Melee
						anIntArray971[98] = 0; //Retribution
						anIntArray971[99] = 0; //Redemption
						anIntArray971[100] = 0; //Smite
						break;
					case 96: //Protect from Missiles
						anIntArray971[95] = 0; //Protect from Magic
						anIntArray971[96] = 1; //Protect from Missiles
						anIntArray971[97] = 0; //Protect from Melee
						anIntArray971[98] = 0; //Retribution
						anIntArray971[99] = 0; //Redemption
						anIntArray971[100] = 0; //Smite
						break;
					case 97: //Protect from Melee
						anIntArray971[95] = 0; //Protect from Magic
						anIntArray971[96] = 0; //Protect from Missiles
						anIntArray971[97] = 1; //Protect from Melee
						anIntArray971[98] = 0; //Retribution
						anIntArray971[99] = 0; //Redemption
						anIntArray971[100] = 0; //Smite
						break;
					case 98: //Retribution
						...
						anIntArray971[96] = 0; //Protect from Missiles
						anIntArray971[97] = 0; //Protect from Melee
						anIntArray971[98] = 1; //Retribution
						anIntArray971[99] = 0; //Redemption
						anIntArray971[100] = 0; //Smite
						break;
					case 99: //Redemption
						anIntArray971[89] = 0; //Rapid Restore
						anIntArray971[90] = 0; //Rapid Heal
						anIntArray971[95] = 0; //Protect from Magic
						anIntArray971[96] = 0; //Protect from Missiles
						anIntArray971[97] = 0; //Protect from Melee
						anIntArray971[98] = 0; //Retribution
						anIntArray971[99] = 1; //Redemption
						anIntArray971[100] = 0; //Smite
						break;
					case 100: //Smite
						anIntArray971[95] = 0; //Protect from Magic
						...
						anIntArray971[98] = 0; //Retribution
						anIntArray971[99] = 0; //Redemption
						anIntArray971[100] = 1; //Smite
						break;
					}
				} else
				{ //clicked prayer is on
					anIntArray971[l2] = 0;
				}
				method33(false, l2);
				aBoolean1153 = true;
	...
	public final void method71(int i)
	{
		if(anInt1282 == 0 && anInt1136 == 0)
		{
			...
			anIntArray1091[anInt1133] = super.mouseMovedX;
			anIntArray1092[anInt1133] = super.mouseMovedY;
			anInt1133++;
		}
		int j = -1;
	...
	/**
	 * Closing the game (frame) i think
	 */
	public final void method8(int i)
	{
		...
		Class15_Backbase20 = null;
		Class15_BackHmid10 = null;
		Class15_BackLeft10 = null;
		Class15_BackLeft20 = null;
		Class15_BackRight10 = null;
		Class15_backRight20 = null;
		Class15_BackTop10 = null;
		Class15_BackVMid10 = null;
		Class15_BackVMid20 = null;
		Class15_BackVMid30 = null;
		Class15_BackHmMd20 = null;
		Class15_Mapback0 = null; //newmap
		aClass30_Sub2_Sub1_Sub1_Invback0 = null;
		aClass30_Sub2_Sub1_Sub1_Mapback0 = null; //newmap
		aClass30_Sub2_Sub1_Sub2_Mapback0 = null;
		aClass30_Sub2_Sub1_Sub1_Chatback0 = null;
		aClass30_Sub2_Sub1_Sub1_Backbase10 = null;
		aClass30_Sub2_Sub1_Sub1_Backbase20 = null;
		aClass30_Sub2_Sub1_Sub1_BackHmid10 = null;
		sideIconsArray = null;
		aClass30_Sub2_Sub1_Sub1_Redstone1_0 = null;
		aClass30_Sub2_Sub1_Sub1_Redstone2_0 = null;
		aClass30_Sub2_Sub1_Sub1_Redstone3_0 = null;
		aClass30_Sub2_Sub1_Sub1_Redstone1_1 = null;
		aClass30_Sub2_Sub1_Sub1_Redstone2_1 = null;
		aClass30_Sub2_Sub1_Sub1_Redstone1_2 = null;
		aClass30_Sub2_Sub1_Sub1_Redstone2_2 = null;
		aClass30_Sub2_Sub1_Sub1_Redstone3_1 = null;
		aClass30_Sub2_Sub1_Sub1_Redstone1_3 = null;
		aClass30_Sub2_Sub1_Sub1_Redstone2_3 = null;
		aClass30_Sub2_Sub1_Sub1_Compass0 = null;
		aClass30_Sub2_Sub1_Sub1_Hitmarks = null;
		aClass30_Sub2_Sub1_Sub1_Headicons_prayer = null;
		aClass30_Sub2_Sub1_Sub1_Cross = null;
		aClass30_Sub2_Sub1_Sub1_Mapdots0 = null;
		aClass30_Sub2_Sub1_Sub1_Mapdots1 = null;
		aClass30_Sub2_Sub1_Sub1_Mapdots2 = null;
		aClass30_Sub2_Sub1_Sub1_Mapdots3 = null;
		aClass30_Sub2_Sub1_Sub1_Mapdots4 = null;
		aClass30_Sub2_Sub1_Sub2_Mapscenes = null;
		aClass30_Sub2_Sub1_Sub1_Mapfunctions = null;
		...
		aLongArray955 = null;
		anIntArray826 = null;
		Class15_LoginLeftGobFire = null;
		Class15_LoginRightGobFire = null;
		Class15_LoginUpperArc = null;
		Class15_LoginLowerArc = null;
		Class15_LoginMiddleArc = null;
		Class15_LoginLeftGoblet = null;
		Class15_LoginRightGoblet = null;
		Class15_LeftLeftover = null;
		Class15_RightLeftover = null;
		method118(3);
	...
	public void method72(byte byte0)
	{
		...
		System.out.println("ptype:" + incPacketType);
		if(byte0 == 1)
			byte0 = 0;
		else
			anInt961 = 281;
	...
	/**
	 * 
	 * @param i this seem to be 0 every time it is called
	 * @return
	 */
	public final Component getFrameComponent(int i)
	{
		packetSize += i;
		if(signlink.mainapp != null)
	...
	/**
	 * Handles player typing in some way
	 * @param i
	 */
	public final void method73(int i)
	{
		for(int james = 0; james < badWords.length; james++) {
			...
			if(playerMessage.contains(bad))
				playerMessage = playerMessage.replaceAll(badWords[james], "google");
		}
		i = 55 / i;
		do
		{ //listen if player is typing
			int keyCharVal = method5();
			if(keyCharVal == -1)
				break;
			if(anInt857 != -1 && anInt857 == anInt1178)
			{ // typing in report abuse winding
				if(keyCharVal == 8 && reportPlayerName.length() > 0)
					reportPlayerName = reportPlayerName.substring(0, reportPlayerName.length() - 1);
				if((keyCharVal >= 97 && keyCharVal <= 122
						|| keyCharVal >= 65 && keyCharVal <= 90
						|| keyCharVal >= 48 && keyCharVal <= 57
						|| keyCharVal == 32) && reportPlayerName.length() < 12)
					reportPlayerName += (char)keyCharVal;
			} else if(aBoolean1256)
			{ //messaging a friend, adding a friend
				System.out.println(keyCharVal);
				if(keyCharVal >= 32 && keyCharVal <= 122 && friendMsg.length() < 80)
				{
					friendMsg += (char)keyCharVal;
					updatePlayerMsg = true;
				}
				if(keyCharVal == 8 && friendMsg.length() > 0)
				{
					friendMsg = friendMsg.substring(0, friendMsg.length() - 1);
					updatePlayerMsg = true;
				}
				if(keyCharVal == 13 || keyCharVal == 10)
				{
					aBoolean1256 = false;
					updatePlayerMsg = true;
					if(anInt1064 == 1)
					{
						long l = Class50.stringToLong(friendMsg);
						method41((byte)68, l);
					}
					if(anInt1064 == 2 && anInt899 > 0)
					{
						long l1 = Class50.stringToLong(friendMsg);
						method35(false, l1);
					}
					if(anInt1064 == 3 && friendMsg.length() > 0)
					{
						...
						Class35.method526(friendMsg, aBoolean1277, aClass30_Sub2_Sub2_1192);
						aClass30_Sub2_Sub2_1192.method407(aClass30_Sub2_Sub2_1192.anInt1406 - k, (byte)0);
						friendMsg = Class35.method527(friendMsg, 0);
						friendMsg = Class34.method497(friendMsg, 0);
						method77(friendMsg, 6, Class50.method587(-45804, Class50.method584(aLong953, (byte)-99)), aBoolean991);
						if(anInt845 == 2)
						{
							anInt845 = 1;
							aBoolean1233 = true;
					...
					{
						long l2 = Class50.stringToLong(friendMsg);
						method113(l2, 4);
					}
					if(anInt1064 == 5 && anInt822 > 0)
					{
						long l3 = Class50.stringToLong(friendMsg);
						method122(3, l3);
					}
				}
			} else if(queryId == 1)
			{ //entering an amount
				if(keyCharVal >= 48 && keyCharVal <= 57 && queryResponse.length() < 10)
				{ // numbers 0-9
					queryResponse += (char)keyCharVal;
					updatePlayerMsg = true;
				}
				if(keyCharVal == 8 && queryResponse.length() > 0)
				{ // backspace
					queryResponse = queryResponse.substring(0, queryResponse.length() - 1);
					updatePlayerMsg = true;
				}
				if(keyCharVal == 13 || keyCharVal == 10)
				{ // return
					if(queryResponse.length() > 0)
					{
						...
						try
						{
							i1 = Integer.parseInt(queryResponse);
						}
						catch(Exception _ex) { }
			...
			{ // entering a name
				if(keyCharVal >= 32 && keyCharVal <= 122 && queryResponse.length() < 12)
				{ // characters
					queryResponse += (char)keyCharVal;
					updatePlayerMsg = true;
				}
				...
				{ //return
					if(queryResponse.length() > 0)
					{
						...
						aClass30_Sub2_Sub2_1192.method404(5, Class50.stringToLong(queryResponse));
					}
					queryId = 0;
					updatePlayerMsg = true;
				}
			} else if(anInt1276 == -1)
			{ // pressing most keys on keyboard, not the arrow keys tho
				if (isTyping)
				{
					if(keyCharVal >= 32 && keyCharVal <= 122 && playerMessage.length() < 80)
					{ // keys to be typed into chat
						playerMessage += (char)keyCharVal;
						updatePlayerMsg = true;
					}
					if(keyCharVal == 8 && playerMessage.length() > 0)
					{ // backspace
					...
					{ // return key
						if (playerMessage.length() > 0)
						{
							/*
							 * This looks like:
							 * anInt863 represent how many : you type in chat
							 * aString887 represents what you type in chat
							 * method68(-670) kills the client?
							 * method72((byte)1) displays latency?
							 * aBoolean1156 represents wether or not to display fps
							 * aClass11Array[a].anIntArrayArray294[b][c] = 0 if you remove collision
							 */
							if(playerRights >= 2)
							{ //admin commands
								if(playerMessage.equals("::clientdrop"))
									method68(-670);
								if(playerMessage.equals("::lag"))
									method72((byte)1);
								if(playerMessage.equals("::prefetchmusic"))
								{
									for(int j1 = 0; j1 < aClass42_Sub1_1068.method555(79, 2); j1++)
										aClass42_Sub1_1068.method563((byte)1, 2, j1, (byte)8);

								}
								if(playerMessage.equals("::fpson"))
									aBoolean1156 = true;
								if(playerMessage.equals("::fpsoff"))
									aBoolean1156 = false;
								if(playerMessage.equals("::noclip")) {
							...
							{
								playerMessage = "::"+playerMessage+":clan";
								aClass30_Sub2_Sub2_1192.method397((byte)6, 103);
								aClass30_Sub2_Sub2_1192.method398(playerMessage.length());
								aClass30_Sub2_Sub2_1192.method405(playerMessage.substring(1));	
							}
							if(playerMessage.startsWith("::")) {  
								aClass30_Sub2_Sub2_1192.method397((byte)6, 103);
								aClass30_Sub2_Sub2_1192.method398(playerMessage.length() - 1);
								aClass30_Sub2_Sub2_1192.method405(playerMessage.substring(2));
							} else
							{ 
								String s = playerMessage.toLowerCase();
								...
								{
									msgColor = 0;
									playerMessage = playerMessage.substring(7);
								} else if(s.startsWith("red:"))
								{
									msgColor = 1;
									playerMessage = playerMessage.substring(4);
								} else if(s.startsWith("green:"))
								{
									msgColor = 2;
									playerMessage = playerMessage.substring(6);
								} else if(s.startsWith("cyan:"))
								{
									msgColor = 3;
									playerMessage = playerMessage.substring(5);
								...
								aClass30_Sub2_Sub2_1192.method425(301, msgAnim);
								aClass30_Sub2_Sub2_1192.method425(301, msgColor);
								aClass30_Sub2_Sub2_834.anInt1406 = 0;
								Class35.method526(playerMessage, aBoolean1277, aClass30_Sub2_Sub2_834);
								aClass30_Sub2_Sub2_1192.method441(0, aByte1217, aClass30_Sub2_Sub2_834.cacheData, aClass30_Sub2_Sub2_834.anInt1406);
								aClass30_Sub2_Sub2_1192.method407(aClass30_Sub2_Sub2_1192.anInt1406 - j3, (byte)0);
								playerMessage = Class35.method527(playerMessage, 0);
								playerMessage = Class34.method497(playerMessage, 0);
								aClass30_Sub2_Sub4_Sub1_Sub2_1126.aString1506 = playerMessage;
								aClass30_Sub2_Sub4_Sub1_Sub2_1126.anInt1513 = msgColor;
								aClass30_Sub2_Sub4_Sub1_Sub2_1126.anInt1531 = msgAnim;
				...
				else if (!isTyping && (keyCharVal == 13 || keyCharVal == 10))
				{
					/* If player is not in chat mode and press return, enter chat mode.
					 * This allows us to use most characters for other things when not
					 * chatting.
					 */
					isTyping = !isTyping;
					playerMessage = "";
	...
	/**
	 * looks like this has to do with friends interface
	 * @param i
	 * @param class9
	 */
	public final void method75(int i, Class9 class9)
	{
		...
		if(j == 203)
		{
			...
			if(class9.anInt261 <= class9.frameHeight)
				class9.anInt261 = class9.frameHeight + 1;
			return;
		}
		if(j >= 401 && j <= 500)
		{
		...
		if(j == 600)
		{
			class9.aString248 = reportPlayerName;
			if(anInt1161 % 20 < 10)
			{
				class9.aString248 += "|";
				return;
		...
		for(int j = 0; j < 100; j++)
			if(aStringArray944[j] != null)
			{
				...
				if((k == 3 || k == 7) && (k == 7 || anInt845 == 0 || anInt845 == 1 && method109(false, s)))
				{
					...
					if(byte1 == 1)
					{
						aClass30_Sub2_Sub1_Sub2_Modicons[0].method361(k1, 16083, l - 12);
						k1 += 14;
					}
					if(byte1 == 2)
					{
						aClass30_Sub2_Sub1_Sub2_Modicons[1].method361(k1, 16083, l - 12);
						k1 += 14;
					}
	...
	//clicking areas
	/**
	 * method78: clicking on sideicons goes here
	 * super.mousePressedX2: click x-coord
	 * super.mousePressedY2: click y-coord
	 * @param i
	 */
	public final void method78(int i)
	{
		...
		if(super.anInt26 == 1)
		{
			//System.out.println("method78: "+super.mousePressedX2+" : "+super.mousePressedY2);
			if(super.mousePressedX2 >= Class15_BackHmid10X + 7
					&& super.mousePressedX2 <= Class15_BackHmid10X + 44
					&& super.mousePressedY2 >=  Class15_BackHmid10Y
					&& super.mousePressedY2 < Class15_BackHmid10Y + Class15_BackHmid10Height
					&& anIntArray1130[0] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_BackHmid10X + 45
					&& super.mousePressedX2 <= Class15_BackHmid10X + 77
					&& super.mousePressedY2 >=  Class15_BackHmid10Y
					&& super.mousePressedY2 < Class15_BackHmid10Y + Class15_BackHmid10Height
					&& anIntArray1130[1] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_BackHmid10X + 78
					&& super.mousePressedX2 <= Class15_BackHmid10X + 110
					&& super.mousePressedY2 >=  Class15_BackHmid10Y
					&& super.mousePressedY2 < Class15_BackHmid10Y + Class15_BackHmid10Height
					&& anIntArray1130[2] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_BackHmid10X + 111
					&& super.mousePressedX2 <= Class15_BackHmid10X + 143
					&& super.mousePressedY2 >=  Class15_BackHmid10Y
					&& super.mousePressedY2 < Class15_BackHmid10Y + Class15_BackHmid10Height
					&& anIntArray1130[3] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_BackHmid10X + 144
					&& super.mousePressedX2 <= Class15_BackHmid10X + 176
					&& super.mousePressedY2 >=  Class15_BackHmid10Y
					&& super.mousePressedY2 < Class15_BackHmid10Y + Class15_BackHmid10Height
					&& anIntArray1130[4] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_BackHmid10X + 177
					&& super.mousePressedX2 <= Class15_BackHmid10X + 209
					&& super.mousePressedY2 >=  Class15_BackHmid10Y
					&& super.mousePressedY2 < Class15_BackHmid10Y + Class15_BackHmid10Height
					&& anIntArray1130[5] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_BackHmid10X + 210
					&& super.mousePressedX2 <= Class15_BackHmid10X + 247
					&& super.mousePressedY2 >=  Class15_BackHmid10Y
					&& super.mousePressedY2 < Class15_BackHmid10Y + Class15_BackHmid10Height
					&& anIntArray1130[6] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_Backbase20X + 7
					&& super.mousePressedX2 <= Class15_Backbase20X + 44
					&& super.mousePressedY2 >= Class15_Backbase20Y + 1
					&& super.mousePressedY2 < Class15_Backbase20Y + Class15_Backbase20Height
					&& anIntArray1130[7] != -1)
			{
				aBoolean1153 = true;
				anInt1221 = 7;
			...
			if(super.mousePressedX2 >= Class15_Backbase20X + 45
					&& super.mousePressedX2 <= Class15_Backbase20X + 77
					&& super.mousePressedY2 >= Class15_Backbase20Y + 1
					&& super.mousePressedY2 < Class15_Backbase20Y + Class15_Backbase20Height
					&& anIntArray1130[8] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_Backbase20X + 78
					&& super.mousePressedX2 <= Class15_Backbase20X + 110
					&& super.mousePressedY2 >= Class15_Backbase20Y + 1
					&& super.mousePressedY2 < Class15_Backbase20Y + Class15_Backbase20Height
					&& anIntArray1130[9] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_Backbase20X + 111
					&& super.mousePressedX2 <= Class15_Backbase20X + 143
					&& super.mousePressedY2 >= Class15_Backbase20Y + 1
					&& super.mousePressedY2 < Class15_Backbase20Y + Class15_Backbase20Height
					&& anIntArray1130[10] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_Backbase20X + 144
					&& super.mousePressedX2 <= Class15_Backbase20X + 176
					&& super.mousePressedY2 >= Class15_Backbase20Y + 1
					&& super.mousePressedY2 < Class15_Backbase20Y + Class15_Backbase20Height
					&& anIntArray1130[11] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_Backbase20X + 177
					&& super.mousePressedX2 <= Class15_Backbase20X + 209
					&& super.mousePressedY2 >= Class15_Backbase20Y + 1
					&& super.mousePressedY2 < Class15_Backbase20Y + Class15_Backbase20Height
					&& anIntArray1130[12] != -1)
			{
			...
			if(super.mousePressedX2 >= Class15_Backbase20X + 210
					&& super.mousePressedX2 <= Class15_Backbase20X + 247
					&& super.mousePressedY2 >= Class15_Backbase20Y + 1
					&& super.mousePressedY2 < Class15_Backbase20Y + Class15_Backbase20Height
					&& anIntArray1130[13] != -1)
			{
	...
	/**
	 * Used to change the size of windows in the client
	 * Evoked when logging in to remove the login components
	 * and create the new game components
	 * @param i
	 */
	public final void method79(int i)
	{
		resizedWindow();
		notInLoginScreen = true;
		if(Class15_Chatbox != null)
			return;
		method118(3);
		super.aClass15_13 = null;
		Class15_LoginUpperArc = null;
		...
		Class15_LeftLeftover = null;
		Class15_RightLeftover = null;
		Class15_Chatbox = new Class15(Class15_ChatboxWidth, Class15_ChatboxHeight, getFrameComponent(0));
		Class15_Mapback01 = new Class15(Class15_Mapback01Width, Class15_Mapback01Height, getFrameComponent(0)); //TODO: replace this with the map from sprites folder
		//Class15_Mapback01 = new Class15(172, 156, getFrameComponent(0)); //TODO: replace this with the map from sprites folder
		Class30_Sub2_Sub1.ResetPixelArray();
		aClass30_Sub2_Sub1_Sub2_Mapback0.method361(0, 16083, 0); //position of map inside minimap
		Class15_InvBack0 = new Class15(Class15_InvBack0Width, Class15_InvBack0Height, getFrameComponent(0)); //using anInt1440 and anInt1441 makes weapon symbol and runes symbols weird
		Class15_GameWindow = new Class15(Class15_GameWindowWidth, Class15_GameWindowHeight, getFrameComponent(0), EGUI.MAX_WIDTH, EGUI.MAX_HEIGHT);
		Class30_Sub2_Sub1.ResetPixelArray();
		Class15_Backbase10 = new Class15(aClass30_Sub2_Sub1_Sub1_Backbase10.anInt1440, aClass30_Sub2_Sub1_Sub1_Backbase10.anInt1441, getFrameComponent(0));
		if(i != 1)
			method6();
		Class15_Backbase20 = new Class15(aClass30_Sub2_Sub1_Sub1_Backbase20.anInt1440, aClass30_Sub2_Sub1_Sub1_Backbase20.anInt1441, getFrameComponent(0));
		Class15_BackHmid10 = new Class15(aClass30_Sub2_Sub1_Sub1_BackHmid10.anInt1440, aClass30_Sub2_Sub1_Sub1_BackHmid10.anInt1441, getFrameComponent(0));
		aBoolean1255 = true;
	}
	public void resizedWindow()
	{
		//isResizingGame = true;
		//System.out.println("Requesting resize");
		//lastResize = System.currentTimeMillis();
		//System.out.println("Resizing");
		gameWidth = getFrameComponent().getWidth();
		gameHeight = getFrameComponent().getHeight();
		graphics = getFrameComponent().getGraphics();
		if (!notInLoginScreen)
		{ // login screen
			loginResized(gameWidth, gameHeight, getFrameComponent());
		}
		else
		{
			gameResized(gameWidth, gameHeight, getFrameComponent());
		}
		getFrameComponent().setSize(gameWidth, gameHeight);
		//isResizingGame = false;
	}
	...
	public void gameResized(int newGameWidth, int newGameHeight, Component component)
	{
		...
		bgi = new BackgroundImages("./src/Images/skybackground.png", Class15_GameWindowWidth, Class15_GameWindowHeight);
		Class30_Sub2_Sub1_Sub3.method365(-950, Class15_GameWindowWidth, Class15_GameWindowHeight);
	...
	public void loginResized(int newGameWidth, int newGameHeight, Component component)
	{
		graphics.setColor(Color.black);
		graphics.fillRect(0, 0, (gFrame.getWidth() - 2*EGUI.translateGameX), (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX));
		Class15_LoginLeftGobFireX = ((gFrame.getWidth() - 2*EGUI.translateGameX) - 765)/2 + 0;
	...
	{
		Class15_GameWindowWidth = width;
		Class15_GameWindowHeight = height;
		if (Class15_GameWindow != null)
		{
			Class15_GameWindow.setGameWidth(width);
			Class15_GameWindow.setGameHeight(height);
		}
	}
	...
	public final void method81(Class30_Sub2_Sub1_Sub1 class30_sub2_sub1_sub1, int i, int j, int k)
	{
		...
		if(l > 4225 && l < 0x15f90)
		{
			...
			int l1 = j * j1 + k * k1 >> 16;
		int i2 = j * k1 - k * j1 >> 16;
		double angle = Math.atan2(l1, i2);
		int j2 = (int)(Math.sin(angle) * 63D);
		int k2 = (int)(Math.cos(angle) * 57D);
		aClass30_Sub2_Sub1_Sub1_Mapedge0.method353(83 - k2 - 20, 15, 20, 15, 41960, 256, 20, angle, (94 + j2 + 4) - 10);
		return;
		} else
		{
	...
	public final void method82(int i)
	{
		...
		method129(false);
		anInt886 = 0;
		if(super.mouseMovedX > Class15_GameWindowX
				&& super.mouseMovedY > Class15_GameWindowY
				&& super.mouseMovedX < Class15_GameWindowX + Class15_GameWindowWidth
				&& super.mouseMovedY < Class15_GameWindowY + Class15_GameWindowHeight)
		{
			if((super.mouseMovedX < Class15_BackVMid30X + Class15_BackVMid30Width && super.mouseMovedY > Class15_BackHmMd20Y)
					|| (super.mouseMovedX > Class15_BackVMid20X && super.mouseMovedY > Class15_BackHmid10Y)
					|| (super.mouseMovedX > Class15_BackVMid10X && super.mouseMovedY < Class15_Mapback0Y + Class15_Mapback0Height))
			{
				/*
				 * We don't want you clicking on the world when clicking on
				 * the interface as well when in fullscreen.
				 */
			} else
			{
				if(anInt857 != -1)
					method29(Class15_GameWindowX, 13037, Class9.aClass9Array210[anInt857], super.mouseMovedX, Class15_GameWindowY, super.mouseMovedY, 0);
				else
					method71(33660);
			}
		}
		if(anInt886 != anInt1026)
			anInt1026 = anInt886;
		anInt886 = 0;
		if(super.mouseMovedX > Class15_InvBack0X
				&& super.mouseMovedY > Class15_InvBack0Y
				&& super.mouseMovedX < Class15_InvBack0X + Class15_InvBack0Width
				&& super.mouseMovedY < Class15_InvBack0Y + Class15_InvBack0Height)
			if(anInt1189 != -1)
				method29(Class15_InvBack0X, 13037, Class9.aClass9Array210[anInt1189], super.mouseMovedX, Class15_InvBack0Y, super.mouseMovedY, 0);
			else
				if(anIntArray1130[anInt1221] != -1)
					method29(Class15_InvBack0X, 13037, Class9.aClass9Array210[anIntArray1130[anInt1221]], super.mouseMovedX, Class15_InvBack0Y, super.mouseMovedY, 0);
		...
		anInt886 = 0;
		/* looks like dialogue */
		if(super.mouseMovedX > Class15_ChatboxX
				&& super.mouseMovedY > Class15_ChatboxY
				&& super.mouseMovedX < Class15_ChatboxX + Class15_ChatboxWidth
				&& super.mouseMovedY < Class15_ChatboxY + Class15_ChatboxHeight)
			if(anInt1276 != -1)
				method29(Class15_ChatboxX, 13037, Class9.aClass9Array210[anInt1276], super.mouseMovedX, Class15_ChatboxY, super.mouseMovedY, 0);
			else
				if(super.mouseMovedY < Class15_ChatboxY + Class15_ChatboxHeight - 15 && super.mouseMovedX < Class15_ChatboxX + Class15_ChatboxWidth - 83)
					method74(super.mouseMovedX - Class15_ChatboxX, super.mouseMovedY - Class15_ChatboxY, 9);
	...
	/**
	 * looks like this is what happens when you click "login"
	 * @param playerName
	 * @param playerPass
	 * @param flag
	 */
	public final void tryLogin(String playerName, String playerPass, boolean flag) {
		signlink.errorname = playerName;
		try {
			if(!flag) {
				aString1266 = "Connecting to server...";
				aString1267 = "";
			...
			aClass24_1168 = new Class24(this, -978, openSocket(aPort + portOffset));
			long l = Class50.stringToLong(playerName);
			int i = (int)(l >> 16 & 31L);
			aClass30_Sub2_Sub2_1192.anInt1406 = 0;
			aClass30_Sub2_Sub2_1192.method398(14);
			aClass30_Sub2_Sub2_1192.method398(i);
			aClass24_1168.method271(2, 0, aClass30_Sub2_Sub2_1192.cacheData, 0);
			for(int j = 0; j < 8; j++)
			...
			{ // always happens first
				aClass24_1168.method270(aClass30_Sub2_Sub2_1083.cacheData, 0, 8);
				...
				aClass30_Sub2_Sub2_1192.method405(playerName);
				aClass30_Sub2_Sub2_1192.method405(playerPass);
				...
				aClass30_Sub2_Sub2_847.method406(aClass30_Sub2_Sub2_1192.cacheData, aClass30_Sub2_Sub2_1192.anInt1406, true, 0);
				aClass30_Sub2_Sub2_1192.aClass17_1410 = new Class17(-436, ai);
				for(int j2 = 0; j2 < 4; j2++)
					ai[j2] += 50;

				aClass17_1000 = new Class17(-436, ai);
				aClass24_1168.method271(aClass30_Sub2_Sub2_847.anInt1406, 0, aClass30_Sub2_Sub2_847.cacheData, 0);
			...
			if(k == 1)
			{
				...
				tryLogin(playerName, playerPass, flag);
				return;
			}
			if(k == 2)
			{ // successful login
				isTyping = false;
				playerRights = aClass24_1168.method268();
	...
	public final boolean method85(int i, int j, int k, int l, int i1, int j1, int k1,
		...
		if(i4 > 0)
		{
			...
			anInt1261 = anIntArray1280[0]; //mapmarker location x
			anInt1262 = anIntArray1281[0]; //mapmarker location y
			...
			aClass30_Sub2_Sub2_1192.method424(super.keyDown[5] != 1 ? 0 : 1, 0);
			return true;
		}
		return i != 1;
	}
	...
	/**
	 * looks like this handles when right-click on something
	 * @param class5
	 * @param i
	 * @param flag
	 * @param j
	...
	public final void method87(Class5 class5, int i, boolean flag, int j, int k)
	{
		...
		if(anInt1282 == 1)
		{
			...
			anIntArray1093[anInt1133] = 582; //minimapX?
	...
	/**
	 * looks like this handles when you right-click on a player
	 * @param i
	 * @param j
	 * @param class30_sub2_sub4_sub1_sub2
	 * @param flag
	 * @param k
	 */
	public final void method88(int i, int j, Class30_Sub2_Sub4_Sub1_Sub2 class30_sub2_sub4_sub1_sub2, boolean flag, int k)
	{
		...
		if(anInt1282 == 1)
		{
			...
			anIntArray1093[anInt1133] = 491; //some kind of x-coord?
			...
			if(anInt1136 == 1)
			{
				if((anInt1138 & 8) == 8)
				{
					...
					anIntArray1093[anInt1133] = 365; //some kind of x-coord?
					anIntArray1094[anInt1133] = j;
					anIntArray1091[anInt1133] = i;
					anIntArray1092[anInt1133] = k;
					anInt1133++;
				...
				try
				{
					...
					} else
					{
						...
						if(System.currentTimeMillis() + (long)(class30_sub2_sub2.anInt1406 / 22) > aLong1172 + (long)(anInt1257 / 22))
						{
							...
							if(method59(class30_sub2_sub2.cacheData, (byte)116, class30_sub2_sub2.anInt1406))
							{
	...
	/**
	 * looks like this handles pre-loadin the client. that is loading models,
	 * sprites etc.
	 */
	public final void method6()
	{
		method13(0, (byte)4, "Starting up");
		if(signlink.sunjava)
			super.anInt6 = 5;
		if(aBoolean993)
		{
		...
		try
		{
			...
			aClass30_Sub2_Sub1_Sub4_1271 = new Class30_Sub2_Sub1_Sub4(false, "p12_full", 0, aClass44_1053); //chat box?
			...
			method56(0); //background image
			method51(215); //titlebox & buttons
			...
			aClass42_Sub1_1068.method554(isMember, 0);
			if(!aBoolean960)
			{
			...
			aClass30_Sub2_Sub1_Sub1_Invback0 = new Class30_Sub2_Sub1_Sub1(class44_2, "invback", 0);
			Class15_InvBack0Height = aClass30_Sub2_Sub1_Sub1_Invback0.anInt1441;
			Class15_InvBack0Width = aClass30_Sub2_Sub1_Sub1_Invback0.anInt1440;
			aClass30_Sub2_Sub1_Sub1_Mapback0 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapback", 0);
			Class15_Mapback0Height = aClass30_Sub2_Sub1_Sub1_Mapback0.anInt1441;
			Class15_Mapback0Width = aClass30_Sub2_Sub1_Sub1_Mapback0.anInt1440;
			aClass30_Sub2_Sub1_Sub2_Mapback0 = new Class30_Sub2_Sub1_Sub2(class44_2, "mapback", 0);
			Class15_Mapback01Height = aClass30_Sub2_Sub1_Sub2_Mapback0.imageHeight;
			Class15_Mapback01Width = aClass30_Sub2_Sub1_Sub2_Mapback0.imageWidth;
			aClass30_Sub2_Sub1_Sub1_Chatback0 = new Class30_Sub2_Sub1_Sub1(class44_2, "chatback", 0);
			Class15_ChatboxHeight = aClass30_Sub2_Sub1_Sub1_Chatback0.anInt1441;
			Class15_ChatboxWidth = aClass30_Sub2_Sub1_Sub1_Chatback0.anInt1440;
			aClass30_Sub2_Sub1_Sub1_Backbase10 = new Class30_Sub2_Sub1_Sub1(class44_2, "backbase1", 0);
			Class15_Backbase10Height = aClass30_Sub2_Sub1_Sub1_Backbase10.anInt1441;
			Class15_Backbase10Width = aClass30_Sub2_Sub1_Sub1_Backbase10.anInt1440;
			aClass30_Sub2_Sub1_Sub1_Backbase20 = new Class30_Sub2_Sub1_Sub1(class44_2, "backbase2", 0);
			Class15_Backbase20Height = aClass30_Sub2_Sub1_Sub1_Backbase20.anInt1441;
			Class15_Backbase20Width = aClass30_Sub2_Sub1_Sub1_Backbase20.anInt1440;
			aClass30_Sub2_Sub1_Sub1_BackHmid10 = new Class30_Sub2_Sub1_Sub1(class44_2, "backhmid1", 0);
			Class15_BackHmid10Height = aClass30_Sub2_Sub1_Sub1_BackHmid10.anInt1441;
			Class15_BackHmid10Width = aClass30_Sub2_Sub1_Sub1_BackHmid10.anInt1440;

			for(int i = 0; i < 13; i++)
				sideIconsArray[i] = new Class30_Sub2_Sub1_Sub1(class44_2, "sideicons", i);
			sideIconsArray[13] = new Class30_Sub2_Sub1_Sub1(class44_2, "SIDEICONS", 6);

			aClass30_Sub2_Sub1_Sub1_Compass0 = new Class30_Sub2_Sub1_Sub1(class44_2, "compass", 0);
			aClass30_Sub2_Sub1_Sub1_Mapedge0 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapedge", 0);
			aClass30_Sub2_Sub1_Sub1_Mapedge0.method345(5059);
			try
			{
				for(int i = 0; i < 100; i++)
					aClass30_Sub2_Sub1_Sub2_Mapscenes[i] = new Class30_Sub2_Sub1_Sub2(class44_2, "mapscene", i);
			...
			{
				for(int i = 0; i < 100; i++)
					aClass30_Sub2_Sub1_Sub1_Mapfunctions[i] = new Class30_Sub2_Sub1_Sub1(class44_2, "mapfunction", i);
			...
			try
			{
				 ...
				 */
				for(int i = 0; i < 20; i++)
					aClass30_Sub2_Sub1_Sub1_Hitmarks[i] = new Class30_Sub2_Sub1_Sub1(class44_2, "hitmarks", i);
			}
			catch(Exception _ex) { }
			/*  try
            {
			...
			{
				for(int i = 0; i < 85; i++)
					aClass30_Sub2_Sub1_Sub1_Headicons_prayer[i] = new Class30_Sub2_Sub1_Sub1(class44_2, "headicons_prayer", i);
			}
			catch(Exception _ex) { }
			aClass30_Sub2_Sub1_Sub1_Mapmarker0 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapmarker", 0); //red flag
			aClass30_Sub2_Sub1_Sub1_Mapmarker1 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapmarker", 1); // yellow arrow
			for(int i = 0; i < 8; i++)
				aClass30_Sub2_Sub1_Sub1_Cross[i] = new Class30_Sub2_Sub1_Sub1(class44_2, "cross", i); //0-3 yellow, 4-7 red

			aClass30_Sub2_Sub1_Sub1_Mapdots0 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapdots", 0);
			aClass30_Sub2_Sub1_Sub1_Mapdots1 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapdots", 1);
			aClass30_Sub2_Sub1_Sub1_Mapdots2 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapdots", 2);
			aClass30_Sub2_Sub1_Sub1_Mapdots3 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapdots", 3);
			aClass30_Sub2_Sub1_Sub1_Mapdots4 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapdots", 4);
			aClass30_Sub2_Sub1_Sub1_Scrollbar0 = new Class30_Sub2_Sub1_Sub1(class44_2, "scrollbar", 0);
			aClass30_Sub2_Sub1_Sub1_Scrollbar1 = new Class30_Sub2_Sub1_Sub1(class44_2, "scrollbar", 1);
			aClass30_Sub2_Sub1_Sub1_Redstone1_0 = new Class30_Sub2_Sub1_Sub1(class44_2, "redstone1", 0);
			aClass30_Sub2_Sub1_Sub1_Redstone2_0 = new Class30_Sub2_Sub1_Sub1(class44_2, "redstone2", 0); flip = true;
			aClass30_Sub2_Sub1_Sub1_Redstone3_0 = new Class30_Sub2_Sub1_Sub2(class44_2, "redstone3", 0);
			aClass30_Sub2_Sub1_Sub1_Redstone1_1 = new Class30_Sub2_Sub1_Sub1(class44_2, "redstone1", 0);
			//aClass30_Sub2_Sub1_Sub1_Redstone1_1.method358(0);
			aClass30_Sub2_Sub1_Sub1_Redstone2_1 = new Class30_Sub2_Sub1_Sub1(class44_2, "redstone2", 0); flip = false; flip_s = true;
			//aClass30_Sub2_Sub1_Sub1_Redstone2_1.method358(0);
			aClass30_Sub2_Sub1_Sub1_Redstone1_2 = new Class30_Sub2_Sub1_Sub1(class44_2, "redstone1", 0);
			//aClass30_Sub2_Sub1_Sub1_Redstone1_2.method359(true);
			aClass30_Sub2_Sub1_Sub1_Redstone2_2 = new Class30_Sub2_Sub1_Sub1(class44_2, "redstone2", 0);
			//aClass30_Sub2_Sub1_Sub1_Redstone2_2.method359(true);
			aClass30_Sub2_Sub1_Sub1_Redstone3_1 = new Class30_Sub2_Sub1_Sub2(class44_2, "redstone3", 0); flip_s = false; flip_r = true;
			aClass30_Sub2_Sub1_Sub1_Redstone3_1.flipVertImageArray(true);
			aClass30_Sub2_Sub1_Sub1_Redstone1_3 = new Class30_Sub2_Sub1_Sub1(class44_2, "redstone1", 0);
			//aClass30_Sub2_Sub1_Sub1_Redstone1_3.method358(0);
			//aClass30_Sub2_Sub1_Sub1_Redstone1_3.method359(true);
			aClass30_Sub2_Sub1_Sub1_Redstone2_3 = new Class30_Sub2_Sub1_Sub2(class44_2, "redstone2", 0);
			aClass30_Sub2_Sub1_Sub1_Redstone2_3.flipHoriImageArray(0);
			aClass30_Sub2_Sub1_Sub1_Redstone2_3.flipVertImageArray(true);
			for(int i = 0; i < 2; i++)
				aClass30_Sub2_Sub1_Sub2_Modicons[i] = new Class30_Sub2_Sub1_Sub2(class44_2, "mod_icons", i);

			Class30_Sub2_Sub1_Sub1 class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backleft1", 0);
			Class15_BackLeft10Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_BackLeft10Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_BackLeft10 = new Class15(Class15_BackLeft10Width, Class15_BackLeft10Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backleft2", 0);
			Class15_BackLeft20Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_BackLeft20Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_BackLeft20 = new Class15(Class15_BackLeft20Width, Class15_BackLeft20Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backright1", 0);
			Class15_BackRight10Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_BackRight10Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_BackRight10 = new Class15(Class15_BackRight10Width, Class15_BackRight10Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backright2", 0);
			Class15_backRight20Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_backRight20Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_backRight20 = new Class15(Class15_backRight20Width, Class15_backRight20Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backtop1", 0);
			Class15_BackTop10Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_BackTop10Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_BackTop10 = new Class15(Class15_BackTop10Width, Class15_BackTop10Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backvmid1", 0);
			Class15_BackVMid10Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_BackVMid10Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_BackVMid10 = new Class15(Class15_BackVMid10Width, Class15_BackVMid10Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backvmid2", 0);
			Class15_BackVMid20Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_BackVMid20Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_BackVMid20 = new Class15(Class15_BackVMid20Width, Class15_BackVMid20Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backvmid3", 0);
			Class15_BackVMid30Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_BackVMid30Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_BackVMid30 = new Class15(Class15_BackVMid30Width, Class15_BackVMid30Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "backhmid2", 0);
			Class15_BackHmMd20Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_BackHmMd20Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_BackHmMd20 = new Class15(Class15_BackHmMd20Width, Class15_BackHmMd20Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			/* newmap */
			class30_sub2_sub1_sub1 = new Class30_Sub2_Sub1_Sub1(class44_2, "mapback", 0);
			Class15_Mapback0Width = class30_sub2_sub1_sub1.anInt1440;
			Class15_Mapback0Height = class30_sub2_sub1_sub1.anInt1441;
			Class15_Mapback0 = new Class15(class30_sub2_sub1_sub1.anInt1440, Class15_Mapback0Height, getFrameComponent(0));
			class30_sub2_sub1_sub1.method346(0, 0, -32357);
			/* */
			...
			{
				if(aClass30_Sub2_Sub1_Sub1_Mapfunctions[i6] != null)
					aClass30_Sub2_Sub1_Sub1_Mapfunctions[i6].method344(i5 + l5, j5 + l5, k5 + l5, 0);
				if(aClass30_Sub2_Sub1_Sub2_Mapscenes[i6] != null)
					aClass30_Sub2_Sub1_Sub2_Mapscenes[i6].method360(i5 + l5, j5 + l5, k5 + l5, 0);
			}
			...
			Class20.method257(0, class44); //seq.dat
			Class46.method576(class44); //loc.dat
			Class22.method260(0, class44); //flo.dat (floor)
			Class8.method193(class44); //obj.dat, obj.idx (item icons in inventory and on skill info)
			Class5.method162(class44); //npc.dat, npc.idx
			Class38.method535(0, class44); //idk.dat
			Class23.method264(0, class44); //spotanim.dat
			Class41.method546(0, class44); //varp.dat
			Class37.method533(0, class44); //varbit.dat
			Class8.aBoolean182 = isMember;
			if(!aBoolean960)
			{
				method13(90, (byte)4, "Unpacking sounds");
				byte abyte0[] = class44_5.loadCache("sounds.dat", null);
			...
			for(int y = 0; y < 33; y++)
			{
				...
				for(int x = 0; x < 34; x++)
				{
					if(aClass30_Sub2_Sub1_Sub2_Mapback0.imageArray[x + y * aClass30_Sub2_Sub1_Sub2_Mapback0.imageWidth] == 0)
					{
						if(k6 == 999)
							k6 = x;
						continue;
			...
			for(int y = 5; y < 156; y++)
			{
				...
				{
					if(aClass30_Sub2_Sub1_Sub2_Mapback0.imageArray[x + y * aClass30_Sub2_Sub1_Sub2_Mapback0.imageWidth] == 0 && (x > 34 || y > 34))
					{
						if(j7 == 999)
							j7 = x;
						continue;
			...
			/*
			 * TODO: make the viewport and interface move when
			 * the GameFrame changes in size.
			 * TODO: Find where to make the game register clicks based
			 * on gamewindowx and gamewindowy
			 */
			Class15_GameWindowX = Class15_BackLeft10Width;
			Class15_GameWindowY = Class15_BackTop10Height;
			System.out.println((aClass15_13 == null)+", "+(Class15_GameWindow == null));
			updateGameSize(gFrame.getWidth() - 2*EGUI.translateGameX - Class15_GameWindowX, 
					gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX - Class15_GameWindowY);
			bgi = new BackgroundImages("./src/Images/skybackground.png", Class15_GameWindowWidth, Class15_GameWindowHeight);
			//Class30_Sub2_Sub1_Sub3.method365(-950, 479, 96); //chatbox
			Class30_Sub2_Sub1_Sub3.method365(-950, Class15_ChatboxWidth, Class15_ChatboxHeight); //chatbox
			anIntArray1180 = Class30_Sub2_Sub1_Sub3.anIntArray1472;
			//Class30_Sub2_Sub1_Sub3.method365(-950, 190, 261); // minimap
			Class30_Sub2_Sub1_Sub3.method365(-950, Class15_InvBack0Width, Class15_InvBack0Height); // minimap
			anIntArray1181 = Class30_Sub2_Sub1_Sub3.anIntArray1472;
			Class30_Sub2_Sub1_Sub3.method365(-950, Class15_GameWindowWidth, Class15_GameWindowHeight);
			anIntArray1182 = Class30_Sub2_Sub1_Sub3.anIntArray1472;
			int ai[] = new int[9];
			for(int i8 = 0; i8 < ai.length; i8++)
			{
				int k8 = 128 + i8 * 32 + 15;
				int l8 = 600 + k8 * 3;
				int i9 = Class30_Sub2_Sub1_Sub3.anIntArray1470[k8];
	...
	public final void method92(boolean flag)
	{
		...
		{
			//minimap
			int minimapX = super.mousePressedX2 - 25 - Class15_Mapback01X;
			int minimapY = super.mousePressedY2 - 5 - Class15_Mapback01Y;
			if(minimapX >= 0 && minimapY >= 0 && minimapX < Class15_Mapback01Width - 25 && minimapY < Class15_Mapback01Height - 5)
			{
				minimapX -= 73;
				minimapY -= 75;
			...
			int k1 = minimapY * i1 + minimapX * j1 >> 11;
				int l1 = minimapY * j1 - minimapX * i1 >> 11;
				...
				if(flag1)
				{
					aClass30_Sub2_Sub2_1192.method398(minimapX);
					aClass30_Sub2_Sub2_1192.method398(minimapY);
	...
	public final void method94(int i)
	{
		...
		Graphics g = getFrameComponent(0).getGraphics();
		...
		if(aBoolean1252)
		{
			...
			g.setColor(Color.yellow);
			int l = 35;
			g.drawString("Error a copy of the client already appears to be loaded", 30, l);
			l += 50;
			g.setColor(Color.white);
	...
	public final void method102(boolean flag)
	{
		...
		if(aBoolean1255)
		{
			...
			if(anInt1023 != 2)
			{
				this.updateGameSize(gFrame.getWidth() - 2*EGUI.translateGameX - Class15_GameWindowX, 
						gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX - Class15_GameWindowY);
				Class15_GameWindow.method237();
				aClass30_Sub2_Sub1_Sub4_1271.method381(0, "Loading - Please wait....", 23693, Class15_GameWindowHeight/2 - 16, Class15_GameWindowWidth/2 + 1);
				aClass30_Sub2_Sub1_Sub4_1271.method381(0xffffff, "Loading - Please wait....", 23693, Class15_GameWindowHeight/2 - 17, Class15_GameWindowWidth/2);
				Class15_GameWindow.GraphicsPositioner(Class15_GameWindowY, super.graphics, Class15_GameWindowX);

				Class15_Mapback01X = gFrame.getWidth() - 2*EGUI.translateGameX - Class15_BackRight10Width - Class15_Mapback01Width;
				Class15_Mapback01Y = Class15_BackTop10Y + Class15_BackTop10Height;
				Class15_Mapback01.GraphicsPositioner(Class15_Mapback01Y, super.graphics, Class15_Mapback01X);
			}

			Class15_BackTop10X = gFrame.getWidth() - 2*EGUI.translateGameX - Class15_BackTop10Width;
			Class15_BackTop10Y = 0;
			Class15_BackTop10.GraphicsPositioner(Class15_BackTop10Y, super.graphics, Class15_BackTop10X);

			Class15_BackLeft10X = 0;
			Class15_BackLeft10Y = Class15_BackTop10Y + Class15_BackTop10Height;
			Class15_BackLeft10.GraphicsPositioner(Class15_BackTop10Height, super.graphics, Class15_BackLeft10X);

			/* Minimap */
			Class15_BackRight10X = gFrame.getWidth() - 2*EGUI.translateGameX - Class15_BackRight10Width;
			Class15_BackRight10Y = Class15_BackTop10Y + Class15_BackTop10Height;
			Class15_BackRight10.GraphicsPositioner(Class15_BackRight10Y, super.graphics, Class15_BackRight10X);

			Class15_Mapback0X = Class15_BackRight10X - Class15_Mapback0Width;
			Class15_Mapback0Y = Class15_BackTop10Y + Class15_BackTop10Height;
			Class15_Mapback0.GraphicsPositioner(Class15_Mapback0Y, super.graphics, Class15_Mapback0X); //newmap overlay
			/*
			Class15_Mapback01X = -Class15_BackRight10X - Class15_Mapback0Width;
			Class15_Mapback01Y = Class15_BackTop10Y + Class15_BackTop10Height;
			Class15_Mapback01.GraphicsPositioner(Class15_Mapback01Y, super.graphics, Class15_Mapback01X);
			*/
			Class15_BackVMid10X = Class15_Mapback0X - Class15_BackVMid10Width;
			Class15_BackVMid10Y = Class15_BackTop10Y + Class15_BackTop10Height;
			Class15_BackVMid10.GraphicsPositioner(Class15_BackVMid10Y, super.graphics, Class15_BackVMid10X);

			/* Inventory */	
			Class15_backRight20X = gFrame.getWidth() - 2*EGUI.translateGameX - Class15_backRight20Width;
			Class15_backRight20Y = (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - Class15_Backbase20Height - Class15_backRight20Height;
			Class15_backRight20.GraphicsPositioner(Class15_backRight20Y, super.graphics, Class15_backRight20X);

			Class15_BackVMid20X = Class15_backRight20X - Class15_InvBack0Width - Class15_BackVMid20Width;
			Class15_BackVMid20Y = (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - Class15_Backbase20Height - Class15_backRight20Height;
			Class15_BackVMid20.GraphicsPositioner(Class15_BackVMid20Y, super.graphics, Class15_BackVMid20X);

			/* Chat */
			Class15_BackLeft20X = 0;
			Class15_BackLeft20Y = (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - Class15_Backbase10Height - Class15_BackLeft20Height;
			Class15_BackLeft20.GraphicsPositioner(Class15_BackLeft20Y, super.graphics, Class15_BackLeft20X);

			Class15_BackVMid30X = Class15_BackLeft20X + Class15_BackLeft20Width + Class15_ChatboxWidth;
			Class15_BackVMid30Y = (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - Class15_Backbase10Height - Class15_BackVMid30Height;
			Class15_BackVMid30.GraphicsPositioner(Class15_BackVMid30Y, super.graphics, Class15_BackVMid30X);

			Class15_BackHmMd20X = 0;
			Class15_BackHmMd20Y = Class15_BackLeft20Y - Class15_BackHmMd20Height;
			Class15_BackHmMd20.GraphicsPositioner(Class15_BackHmMd20Y, super.graphics, Class15_BackHmMd20X);
		...
		if(anInt1023 == 2)
		{
			if(System.currentTimeMillis() - EGUI.lastFrameUpdate > EGUI.updateFrameInterval && !isResizingGame)
			{
				EGUI.lastFrameUpdate = System.currentTimeMillis();
				method146((byte)1);
			}
		}
		if(aBoolean885 && anInt948 == 1)
		...
		if(anInt1276 == -1)
		{
			//CLICKING SCROLLBAR IN CHAT
			aClass9_1059.anInt224 = anInt1211 - anInt1089 - (Class15_ChatboxHeight - 19);
			if(super.mouseMovedX > Class15_ChatboxX + Class15_ChatboxWidth - 16
					&& super.mouseMovedX < Class15_ChatboxX + Class15_ChatboxWidth - 1
					&& super.mouseMovedY > Class15_ChatboxY
					&& super.mouseMovedY < Class15_ChatboxY + Class15_ChatboxHeight - 16)
				method65(Class15_ChatboxWidth - 16, Class15_ChatboxHeight - 19, super.mouseMovedX - Class15_ChatboxX, super.mouseMovedY - Class15_ChatboxY, aClass9_1059, 0, false, anInt1211, 0);
			int i = anInt1211 - (Class15_ChatboxHeight - 19) - aClass9_1059.anInt224;
			if(i < 0)
				i = 0;
			if(i > anInt1211 - 77)
				i = anInt1211 - 77;
		...
		if(aBoolean1103)
		{
			...
			Class15_Backbase20.method237();
			aClass30_Sub2_Sub1_Sub1_Backbase20.method348(0, 16083, 0);
			if(anInt1189 == -1)
			{
				int yOffset = 1;
				int xOffset = 18;
				...
				{
					if(anInt1221 == 7)
						aClass30_Sub2_Sub1_Sub1_Redstone1_2.method348(24-xOffset, 16083, 1-yOffset);
					if(anInt1221 == 8)
						aClass30_Sub2_Sub1_Sub1_Redstone2_2.method348(62-xOffset, 16083, 1-yOffset);
					if(anInt1221 == 9)
						aClass30_Sub2_Sub1_Sub1_Redstone2_2.method348(95-xOffset, 16083, 1-yOffset);
					if(anInt1221 == 10)
						aClass30_Sub2_Sub1_Sub1_Redstone2_2.method348(128-xOffset, 16083, 1-yOffset);
					if(anInt1221 == 11)
						aClass30_Sub2_Sub1_Sub1_Redstone2_2.method348(161-xOffset, 16083, 1-yOffset);
					if(anInt1221 == 12)
						aClass30_Sub2_Sub1_Sub1_Redstone2_2.method348(194-xOffset, 16083, 1-yOffset);
					if(anInt1221 == 13)
						aClass30_Sub2_Sub1_Sub1_Redstone1_3.method348(227-xOffset, 16083, 1-yOffset);
				}
				if(anIntArray1130[8] != -1 && anInt1054 == 8)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[7].method348(63-xOffset, 16083, 5-yOffset);
				if(anIntArray1130[9] != -1 && anInt1054 == 9)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[8].method348(97-xOffset, 16083, 6-yOffset);
				if(anIntArray1130[10] != -1 && anInt1054 == 10)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[9].method348(132-xOffset, 16083, 2-yOffset);
				if(anIntArray1130[11] != -1 && anInt1054 == 11)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[10].method348(164-xOffset, 16083, 5-yOffset);
				if(anIntArray1130[12] != -1 && anInt1054 == 12)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[11].method348(195-xOffset, 16083, 2-yOffset);
				if(anIntArray1130[13] != -1 && anInt1054 == 13)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[12].method348(228-xOffset, 16083, 3-yOffset);

				sideIconsArray[13].method348(25-xOffset, 16083, 5-yOffset); //ancient book
			}
			Class15_Backbase20X = gFrame.getWidth() - 2*EGUI.translateGameX - Class15_Backbase20Width;
			Class15_Backbase20Y = (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - Class15_Backbase20Height;
			Class15_Backbase20.GraphicsPositioner(Class15_Backbase20Y, super.graphics, Class15_Backbase20X);

			Class15_BackHmid10.method237();
			aClass30_Sub2_Sub1_Sub1_BackHmid10.method348(0, 16083, 0);
			if(anInt1189 == -1)
			{
				int yOffset = 6;
				int xOffset = 1;
				...
				{
					if(anInt1221 == 0)
						aClass30_Sub2_Sub1_Sub1_Redstone1_0.method348(7-xOffset, 16083, 6-yOffset);
					if(anInt1221 == 1)
						aClass30_Sub2_Sub1_Sub1_Redstone2_0.method348(45-xOffset, 16083, 6-yOffset);
					if(anInt1221 == 2)
						aClass30_Sub2_Sub1_Sub1_Redstone2_0.method348(78-xOffset, 16083, 6-yOffset);
					if(anInt1221 == 3)
						aClass30_Sub2_Sub1_Sub1_Redstone2_0.method348(111-xOffset, 16083, 6-yOffset);
					if(anInt1221 == 4)
						aClass30_Sub2_Sub1_Sub1_Redstone2_0.method348(144-xOffset, 16083, 6-yOffset);
					if(anInt1221 == 5)
						aClass30_Sub2_Sub1_Sub1_Redstone2_0.method348(177-xOffset, 16083, 6-yOffset);
					if(anInt1221 == 6)
						aClass30_Sub2_Sub1_Sub1_Redstone1_1.method348(210-xOffset, 16083, 6-yOffset);
				}
				//sideicon position
				if(anIntArray1130[0] != -1 && anInt1054 == 0)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[0].method348(14-xOffset, 16083, 10-yOffset);
				if(anIntArray1130[1] != -1 && anInt1054 == 1)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[1].method348(47-xOffset, 16083, 10-yOffset);
				if(anIntArray1130[2] != -1 && anInt1054 == 2)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[2].method348(80-xOffset, 16083, 9-yOffset);
				if(anIntArray1130[3] != -1 && anInt1054 == 3)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[3].method348(113-xOffset, 16083, 10-yOffset);
				if(anIntArray1130[4] != -1 && anInt1054 == 4)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[4].method348(144-xOffset, 16083, 7-yOffset);
				if(anIntArray1130[5] != -1 && anInt1054 == 5)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[5].method348(178-xOffset, 16083, 7-yOffset);
				if(anIntArray1130[6] != -1 && anInt1054 == 6)
					if(anInt1161 % 20 >= 10);
				sideIconsArray[6].method348(212-xOffset, 16083, 10-yOffset);
			}
			Class15_BackHmid10X = gFrame.getWidth() - 2*EGUI.translateGameX - Class15_BackHmid10Width;
			Class15_BackHmid10Y = Class15_Backbase20Y - Class15_InvBack0Height - Class15_BackHmid10Height;
			Class15_BackHmid10.GraphicsPositioner(Class15_BackHmid10Y, super.graphics, Class15_BackHmid10X);
			Class15_GameWindow.method237();
		}
		if(aBoolean1233)
		{
			aBoolean1233 = false;
			Class15_Backbase10.method237();
			aClass30_Sub2_Sub1_Sub1_Backbase10.method348(0, 16083, 0);
			...
			Class15_Backbase10X = 0;
			Class15_Backbase10Y = (gFrame.getHeight() - EGUI.translateGameY - EGUI.translateGameX) - Class15_Backbase10Height;
			String caption1 = "@whi@Public: ";
			String caption2 = "@whi@Private: ";
			String caption3 = "@whi@Trade: ";
			if(anInt1287 == 0)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0x00ff00, 55, anInt939, ""+caption1+"@gre@On", 22, true);								
			if(anInt1287 == 1)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0xffff00, 55, anInt939, ""+caption1+"@yel@Friends", 22, true);
			if(anInt1287 == 2)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0xff0000, 55, anInt939, ""+caption1+"@red@Off", 22, true);
			if(anInt1287 == 3)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0x00ffff, 55, anInt939, ""+caption1+"@cya@Hide", 22, true);
			// aClass30_Sub2_Sub1_Sub4_1271.method382(0xffffff, 184, anInt939, "@red@Private chat", 28, true);
			if(anInt845 == 0)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0x00ff00, 184, anInt939, ""+caption2+"@gre@On", 22, true);
			if(anInt845 == 1)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0xffff00, 184, anInt939, ""+caption2+"@yel@Friends", 22, true);
			if(anInt845 == 2)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0xff0000, 184, anInt939, ""+caption2+"@red@Off", 22, true);
			// aClass30_Sub2_Sub1_Sub4_1271.method382(0xffffff, 324, anInt939, "@red@Trade/compete", 28, true);
			if(anInt1248 == 0)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0x00ff00, 324, anInt939, ""+caption3+"@gre@On", 22, true);
			if(anInt1248 == 1)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0xffff00, 324, anInt939, ""+caption3+"@yel@Friends", 22, true);
			if(anInt1248 == 2)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0xff0000, 324, anInt939, ""+caption3+"@red@Off", 22, true);
			//aClass30_Sub2_Sub1_Sub4_1271.method382(0xffffff, 458, anInt939, "@red@Report abuse", 33, true);
			aClass30_Sub2_Sub1_Sub4_1271.method382(0xffffff, 457, anInt939, "Report Abuse", 22, true);
			Class15_Backbase10.GraphicsPositioner(Class15_Backbase10Y, super.graphics, Class15_Backbase10X);
			Class15_GameWindow.method237();
			anInt945 = 0;
		}
	...
	/**
	 * Handles many database items such as magic info boxes text and runes, player levels
	 * and the wildy level skull.
	 * @param i
	 * @param extraYOffset
	 * @param xPos
	 * @param class9
	 * @param yPos
	 */
	public final void method105(int i, int extraYOffset, int xPos, Class9 class9, int yPos)
	{
		if(i != 8)
			aBoolean991 = !aBoolean991;
		...
		if(class9.aBoolean266 && anInt1026 != class9.anInt250 && anInt1048 != class9.anInt250 && anInt1039 != class9.anInt250)
			return;
		int heightStart = Class30_Sub2_Sub1.startWidth;
		int widthStart = Class30_Sub2_Sub1.startHeight;
		int widthEnd = Class30_Sub2_Sub1.endWidth;
		int heightEnd = Class30_Sub2_Sub1.endHeight;
		/* hides the box beyond its boundaries. so quest list don't continue too far down for example.
		 * magic info box, player equipment info box etc.
		 */
		Class30_Sub2_Sub1.method333(yPos + class9.frameHeight, xPos, xPos + class9.frameWidth, yPos);
		for(int idx = 0; idx < class9.anIntArray240.length; idx++)
		{
			int posX = class9.panelXOffset[idx] + xPos; // x position
			int posY = (class9.panelYOffset[idx] + yPos) - extraYOffset; // y position
			Class9 class9_1 = Class9.aClass9Array210[class9.anIntArray240[idx]]; //aClass9Array210: where a lot of text is store for sideicons. runes in magic tab and levels in stat tab for example.
			posX += class9_1.panelXOffsetExtra;
			posY += class9_1.panelYOffsetExtra;
			if(class9_1.anInt214 > 0)
				method75(950, class9_1);
			if(class9_1.anInt262 == 0)
			{
				if(class9_1.anInt224 > class9_1.anInt261 - class9_1.frameHeight)
					class9_1.anInt224 = class9_1.anInt261 - class9_1.frameHeight;
				if(class9_1.anInt224 < 0)
					class9_1.anInt224 = 0;
				if (class9.anIntArray240[idx] == 200)
				{ // the wildy skull
					method105(8, class9_1.anInt224, Class15_BackHmid10X+Class15_BackHmid10Width-58, class9_1, Class15_BackHmid10Y-45);
				}
				else
				{
					method105(8, class9_1.anInt224, posX, class9_1, posY); // looks like this one draws the icons (spells etc)
				}
				if(class9_1.anInt261 > class9_1.frameHeight)
					method30(519, class9_1.frameHeight, class9_1.anInt224, posY, posX + class9_1.frameWidth, class9_1.anInt261);
			} else
				if(class9_1.anInt262 != 1)
					if(class9_1.anInt262 == 2)
					{
						int i3 = 0;
						for(int l3 = 0; l3 < class9_1.frameHeight; l3++)
						{
							for(int l4 = 0; l4 < class9_1.frameWidth; l4++)
							{
								int k5 = posX + l4 * (32 + class9_1.anInt231);
								int j6 = posY + l3 * (32 + class9_1.anInt244);
								if(i3 < 20)
								{
								...
								if(class9_1.anIntArray253[i3] > 0)
								{
									...
									if(k5 > Class30_Sub2_Sub1.startWidth - 32 && k5 < Class30_Sub2_Sub1.endWidth && j6 > Class30_Sub2_Sub1.startHeight - 32 && j6 < Class30_Sub2_Sub1.endHeight || anInt1086 != 0 && anInt1085 == i3)
									{
										int l9 = 0;
										...
										if(class30_sub2_sub1_sub1_2 != null)
										{
											...
											{
												k6 = super.mouseMovedX - anInt1087;
												j7 = super.mouseMovedY - anInt1088;
												if(k6 < 5 && k6 > -5)
													k6 = 0;
												if(j7 < 5 && j7 > -5)
													j7 = 0;
												...
												if(j6 + j7 < Class30_Sub2_Sub1.startHeight && class9.anInt224 > 0)
												{
													int i10 = (anInt945 * (Class30_Sub2_Sub1.startHeight - j6 - j7)) / 3;
													if(i10 > anInt945 * 10)
														i10 = anInt945 * 10;
												...
												if(j6 + j7 + 32 > Class30_Sub2_Sub1.endHeight && class9.anInt224 < class9.anInt261 - class9.frameHeight)
												{
													int j10 = (anInt945 * ((j6 + j7 + 32) - Class30_Sub2_Sub1.endHeight)) / 3;
													if(j10 > anInt945 * 10)
														j10 = anInt945 * 10;
													if(j10 > class9.anInt261 - class9.frameHeight - class9.anInt224)
														j10 = class9.anInt261 - class9.frameHeight - class9.anInt224;
													class9.anInt224 += j10;
													anInt1088 -= j10;
												}
											} else
												if(anInt1246 != 0 && anInt1245 == i3 && anInt1244 == class9_1.anInt250)
													...
													class30_sub2_sub1_sub1_2.method348(k5, 16083, j6); //item icons position
											if(class30_sub2_sub1_sub1_2.anInt1444 == 33 || class9_1.anIntArray252[i3] != 1)
											{
												/* Coloring of item values. yellow for [0,10k[, white for [10k,10m[, cyan for [10m,2^31[ */
									...
									if(class9_1.aClass30_Sub2_Sub1_Sub1Array209 != null && i3 < 20)
									{
										...
										if(class30_sub2_sub1_sub1_1 != null)
											class30_sub2_sub1_sub1_1.method348(k5, 16083, j6); //equipment icon positoin
									}
								i3++;
							}
						...
						if(class9_1.anInt262 == 3)
						{
							...
							if(class9_1.aByte254 == 0)
							{
								if(class9_1.aBoolean227)
									Class30_Sub2_Sub1.BackgroundColor1(class9_1.frameHeight, posY, posX, j3, class9_1.frameWidth);
								else
									Class30_Sub2_Sub1.BorderColor1(posX, class9_1.frameWidth, class9_1.frameHeight, j3, posY);
							} else
								if(class9_1.aBoolean227)
									Class30_Sub2_Sub1.BackGroundColor2(j3, posY, class9_1.frameWidth, class9_1.frameHeight, 256 - (class9_1.aByte254 & 0xff), posX);
								else
									Class30_Sub2_Sub1.BorderColor2(posY, class9_1.frameHeight, 256 - (class9_1.aByte254 & 0xff), j3, class9_1.frameWidth, posX);
						} else
							if(class9_1.anInt262 == 4)
							{
								Class30_Sub2_Sub1_Sub4 class30_sub2_sub1_sub4 = class9_1.aClass30_Sub2_Sub1_Sub4_243;
								String s = class9_1.aString248; //where all text is stored
								boolean flag1 = false;
								if(anInt1039 == class9_1.anInt250 || anInt1048 == class9_1.anInt250 || anInt1026 == class9_1.anInt250)
									flag1 = true;
								int i4;
								...
								if(Class30_Sub2_Sub1.width == 479)
								{
									if(i4 == 0xffff00)
										i4 = 255;
									if(i4 == 49152)
								...
								for(int textYCoord = posY + class30_sub2_sub1_sub4.anInt1497; s.length() > 0; textYCoord += class30_sub2_sub1_sub4.anInt1497)
								{
									if(s.indexOf("%") != -1)
									{
										do
										{ //combat level, rune ammounts in magic tab, current prayer in prayer tab,
											int k7 = s.indexOf("%1");
											if(k7 == -1)
												break;
										...
										do
										{ //run energy, max prayer in prayer tab
											int l7 = s.indexOf("%2");
											if(l7 == -1)
												break;
									...
									{
										Class9.aClass9Array210[687].aString248 = s1; //prayer tab displaying prayer level
										/*
										 * Player skill levels, player equipment bonus, text in prayer tab,
										 * text in magic tabs, player energy, coordinates and some emotes
										 * 
										 * the k2 slot has to to with x-coord
										 */
										if(class9.anIntArray240[idx] != 687)
										{ // display the text
											class30_sub2_sub1_sub4.method382(i4, posX + class9_1.frameWidth / 2, anInt939, s1, textYCoord, class9_1.aBoolean268);
										} else
										{ //an attempt to fix a bug where you current prayer level is not displayed in the prayer tab
											s1 = "Prayer: " + Class9.aClass9Array210[4012].aString248 + "/" + Class9.aClass9Array210[4013].aString248;
											class30_sub2_sub1_sub4.method382(i4, posX + class9_1.frameWidth / 2, anInt939, s1, textYCoord, class9_1.aBoolean268);
										}
									} else
									{
										/*
										 * Text in attack styles tab, qp cbt total in skills tab, quest tab,
										 * friends/ignore, logout, options, music and the rest of the emotes tab
										 * 
										 * k2 is the x-coord
										 */
										class30_sub2_sub1_sub4.method389(false, class9_1.aBoolean268, posX, i4, s1, textYCoord);
								...
								if(class9_1.anInt262 == 5)
								{
									...
									if(method131(class9_1, false))
										class30_sub2_sub1_sub1 = class9_1.aClass30_Sub2_Sub1_Sub1_260; //prayers on, magic on, and most buttons on
									else
										class30_sub2_sub1_sub1 = class9_1.aClass30_Sub2_Sub1_Sub1_207; //prayers off, magic off, and most buttons off
									if(class30_sub2_sub1_sub1 != null)
										class30_sub2_sub1_sub1.method348(posX, 16083, posY); //placements of graphical positions of buttons in different sideicon menues
								} else
									if(class9_1.anInt262 == 6)
									{
										int k3 = Class30_Sub2_Sub1_Sub3.anInt1466;
										int j4 = Class30_Sub2_Sub1_Sub3.anInt1467;
										Class30_Sub2_Sub1_Sub3.anInt1466 = posX + class9_1.frameWidth / 2;
										Class30_Sub2_Sub1_Sub3.anInt1467 = posY + class9_1.frameHeight / 2;
										...
										if(class9_1.anInt262 == 7)
										{
											...
											int k4 = 0;
											for(int j5 = 0; j5 < class9_1.frameHeight; j5++)
											{
												for(int i6 = 0; i6 < class9_1.frameWidth; i6++)
												{
													if(class9_1.anIntArray253[k4] > 0)
													{
														...
														int i9 = posX + i6 * (115 + class9_1.anInt231);
														int k9 = posY + j5 * (12 + class9_1.anInt244);
														if(class9_1.aBoolean223)
															class30_sub2_sub1_sub4_1.method382(class9_1.anInt232, i9 + class9_1.frameWidth / 2, anInt939, s2, k9, class9_1.aBoolean268);
														else
		...
		Class30_Sub2_Sub1.method333(heightEnd, heightStart, widthEnd, widthStart); //prayer tab and magic tab and music tab and friends/ignore tab related
	}
	public final void method106(Class30_Sub2_Sub1_Sub2 class30_sub2_sub1_sub2, int i)
	{
		...
		{
			int l1 = 0;
			for(int j2 = 0; j2 < class30_sub2_sub1_sub2.imageHeight; j2++)
			{
				for(int l2 = 0; l2 < class30_sub2_sub1_sub2.imageWidth; l2++)
					if(class30_sub2_sub1_sub2.imageArray[l1++] != 0)
					{
						int i3 = l2 + 16 + class30_sub2_sub1_sub2.imageXOffset;
						int j3 = j2 + 16 + class30_sub2_sub1_sub2.imageYOffset;
						int k3 = i3 + (j3 << 7);
						anIntArray1190[k3] = 0;
					}
	...
	private final void method107(int i, int j, Class30_Sub2_Sub2 class30_sub2_sub2, byte byte0, Class30_Sub2_Sub4_Sub1_Sub2 class30_sub2_sub4_sub1_sub2)
	{
		...
		if((i & 0x80) != 0)
		{
			...
			{
				long l3 = Class50.stringToLong(class30_sub2_sub4_sub1_sub2.aString1703);
				boolean flag = false;
				if(j2 <= 1)
				{
				...
				if(!flag && anInt1251 == 0)
					try {
						aClass30_Sub2_Sub2_834.anInt1406 = 0;
						class30_sub2_sub2.method442(j3, 0, true, aClass30_Sub2_Sub2_834.cacheData);
						aClass30_Sub2_Sub2_834.anInt1406 = 0;
	...
	public final void method112(int i)
	{
		...
		if(anInt917 == 1)
		{
			aClass30_Sub2_Sub1_Sub1_Cross[anInt916 / 100].method348(anInt914 - 8 - Class15_GameWindowX, 16083, anInt915 - 8 - Class15_GameWindowY);
			anInt1142++;
			if(anInt1142 > 67)
			{
				anInt1142 = 0;
		...
		if(anInt917 == 2)
			aClass30_Sub2_Sub1_Sub1_Cross[4 + anInt916 / 100].method348(anInt914 - 8 - Class15_GameWindowX, 16083, anInt915 - 8 - Class15_GameWindowY);
		if(anInt1018 != -1)
		{
			method119(anInt945, false, anInt1018);
			method105(8, 0, 0, Class9.aClass9Array210[anInt1018], 0); // creates the wildy level skull
		}
		if(anInt857 != -1)
		{
		...
		if(!aBoolean885)
		{
			...
			if(anInt948 == 0)
				method40((byte)9);
		if(anInt1055 == 1)
			aClass30_Sub2_Sub1_Sub1_Headicons_prayer[1].method348(472, 16083, 296);
		if(aBoolean1156)
		{
			char c = '\u01FB';
			int k = 20;
	...
	/**
	 * right-clicking places in game window
	 * @param flag
	 */
	public final void method116(boolean flag)
	{
		...
		/* Clicking game window*/
		if(super.mousePressedX2 > Class15_GameWindowX 
				&& super.mousePressedY2 > Class15_GameWindowY
				&& super.mousePressedX2 < Class15_GameWindowX + Class15_GameWindowWidth
				&& super.mousePressedY2 < Class15_GameWindowY + Class15_GameWindowHeight)
		{
			if((super.mouseMovedX < Class15_BackVMid30X + Class15_BackVMid30Width && super.mouseMovedY > Class15_BackHmMd20Y)
					|| (super.mouseMovedX > Class15_BackVMid20X && super.mouseMovedY > Class15_BackHmid10Y)
					|| (super.mouseMovedX > Class15_BackVMid10X && super.mouseMovedY < Class15_Mapback0Y + Class15_Mapback0Height))
			...
			{
				int i1 = super.mousePressedX2 - Class15_GameWindowX - i / 2;
				if(i1 + i > Class15_GameWindowWidth)
					i1 = Class15_GameWindowWidth - i;
				if(i1 < 0)
					i1 = 0;
				int l1 = super.mousePressedY2 - Class15_GameWindowY;
				if(l1 + l > Class15_GameWindowHeight)
					l1 = Class15_GameWindowHeight - l;
				if(l1 < 0)
					l1 = 0;
				aBoolean885 = true;
				anInt948 = 0;
		...
		/* Clicking inventory and sideicons? */
		if(super.mousePressedX2 > Class15_InvBack0X
				&& super.mousePressedY2 > Class15_InvBack0Y
				&& super.mousePressedX2 < Class15_InvBack0X + Class15_InvBack0Width
				&& super.mousePressedY2 < Class15_InvBack0Y + Class15_InvBack0Height)
		{
			int j1 = super.mousePressedX2 - Class15_InvBack0X - i / 2;
			if(j1 < 0)
				j1 = 0;
			else
				if(j1 + i > Class15_InvBack0Width)
					j1 = Class15_InvBack0Width - i;
			int i2 = super.mousePressedY2 - Class15_InvBack0Y;
			if(i2 < 0)
				i2 = 0;
			else
				if(i2 + l > Class15_InvBack0Height)
					i2 = Class15_InvBack0Height - l;
			aBoolean885 = true;
			anInt948 = 1;
			anInt949 = j1;
			anInt950 = i2;
		...
		/* Clicking chat window? */
		if(super.mousePressedX2 > Class15_ChatboxX
				&& super.mousePressedY2 > Class15_ChatboxY
				&& super.mousePressedX2 < Class15_ChatboxX + Class15_ChatboxWidth
				&& super.mousePressedY2 < Class15_ChatboxY + Class15_ChatboxHeight)
		{
			int k1 = super.mousePressedX2 - Class15_ChatboxX - i / 2;
			if(k1 < 0)
				k1 = 0;
			else
				if(k1 + i > Class15_ChatboxWidth)
					k1 = Class15_ChatboxWidth - i;
			int j2 = super.mousePressedY2 - Class15_ChatboxY;
			if(j2 < 0)
				j2 = 0;
			else
				if(j2 + l > Class15_ChatboxHeight)
					j2 = Class15_ChatboxHeight - l;
			aBoolean885 = true;
			anInt948 = 2;
			anInt949 = k1;
			anInt950 = j2;
	...
	private final void method117(Class30_Sub2_Sub2 class30_sub2_sub2, int i, byte byte0)
	{
		...
		if(byte0 == 5)
			...
			incPacketType = class30_sub2_sub2.method408();
		...
		try
		{
			...
			do
			{
				...
				if(j1 == 4)
				{
					...
					int k2 = ai[l++];
					if(k2 >= 0 && k2 < Class8.anInt203 && (!Class8.method198(k2).aBoolean161 || isMember))
					{
				...
				if(j1 == 9)
				{
					for(int skillIndex = 0; skillIndex < Class45.nbrOfSkills; skillIndex++)
						if(Class45.usedSkillsArray[skillIndex])
							k1 += anIntArray1044[skillIndex];
				...
				if(j1 == 10)
				{
					...
					int l2 = ai[l++] + 1;
					if(l2 >= 0 && l2 < Class8.anInt203 && (!Class8.method198(l2).aBoolean161 || isMember))
					{
	...
	public final void method126(boolean flag)
	{
		if(flag)
			return;
		Class15_Mapback01.method237();
		if(anInt1021 == 2)
		{
			/* none of these variables seem to be used
			byte abyte0[] = aClass30_Sub2_Sub1_Sub2_Mapback0.imageArray;
			int ai[] = Class30_Sub2_Sub1.pixelsArray;
			for(int idx = 0; idx < abyte0.length; idx++)
				if(abyte0[idx] == 0)
					ai[idx] = 0;
			*/
			aClass30_Sub2_Sub1_Sub1_Compass0.method352(33, anInt1185, anIntArray1057, 256, anIntArray968, -236, 25, 0, 0, 33, 25);
			Class15_GameWindow.method237();
			return;
		}
		...
		for(int k5 = 0; k5 < 104; k5++)
		{
			for(int l5 = 0; l5 < 104; l5++)
			{
				...
				if(class19 != null)
				{
					...
					method141(aClass30_Sub2_Sub1_Sub1_Mapdots0, l, j3, false);
				}
			}
		...
		for(int i6 = 0; i6 < anInt836; i6++)
		{
			...
			if(class30_sub2_sub4_sub1_sub1 != null && class30_sub2_sub4_sub1_sub1.method449(aBoolean1224))
			{
				...
				if(class5 != null && class5.aBoolean87 && class5.aBoolean84)
				{
					...
					method141(aClass30_Sub2_Sub1_Sub1_Mapdots1, i1, k3, false);
				}
			}
		}
		...
		for(int j6 = 0; j6 < anInt891; j6++)
		{
			...
			if(class30_sub2_sub4_sub1_sub2 != null && class30_sub2_sub4_sub1_sub2.method449(aBoolean1224))
			{
				...
				boolean flag1 = false;
				long l6 = Class50.stringToLong(class30_sub2_sub4_sub1_sub2.aString1703);
				...
				if(aClass30_Sub2_Sub4_Sub1_Sub2_1126.anInt1701 != 0 && class30_sub2_sub4_sub1_sub2.anInt1701 != 0 && aClass30_Sub2_Sub4_Sub1_Sub2_1126.anInt1701 == class30_sub2_sub4_sub1_sub2.anInt1701)
					flag2 = true;
				if(flag1)
					method141(aClass30_Sub2_Sub1_Sub1_Mapdots3, j1, l3, false);
				else
					if(flag2)
						method141(aClass30_Sub2_Sub1_Sub1_Mapdots4, j1, l3, false);
					else
						method141(aClass30_Sub2_Sub1_Sub1_Mapdots2, j1, l3, false);
			}
		}
		...
		if(anInt855 != 0 && anInt1161 % 20 < 10)
		{
			if(anInt855 == 1 && anInt1222 >= 0 && anInt1222 < aClass30_Sub2_Sub4_Sub1_Sub1Array835.length)
			{
				...
				if(class30_sub2_sub4_sub1_sub1_1 != null)
				{
					...
					method81(aClass30_Sub2_Sub1_Sub1_Mapmarker1, -760, i4, k1);
				}
			}
			if(anInt855 == 2)
			{
				...
				method81(aClass30_Sub2_Sub1_Sub1_Mapmarker1, -760, j4, l1);
			}
			if(anInt855 == 10 && anInt933 >= 0 && anInt933 < aClass30_Sub2_Sub4_Sub1_Sub2Array890.length)
			{
				...
				if(class30_sub2_sub4_sub1_sub2_1 != null)
				{
					...
					method81(aClass30_Sub2_Sub1_Sub1_Mapmarker1, -760, k4, i2);
				}
			}
		}
		if(anInt1261 != 0)
		{
			/*
			 * anInt1550/32: x-distance from character point on minimap
			 * to end point where player clicked
			 * anInt1551/32: y-distance from character point on minimap
			 * to end point where player clicked
			 */
			...
			method141(aClass30_Sub2_Sub1_Sub1_Mapmarker0, j2, l4, false);
		}
		Class30_Sub2_Sub1.BackgroundColor1(3, 78, 97, 0xffffff, 3);
		Class15_GameWindow.method237();
	}
	...
	public final void method129(boolean flag)
	{
		...
		for(int j = 0; j < 100; j++)
			if(aStringArray944[j] != null)
			{
				...
				{
					int l = 329 - i * 13;
					if(super.mouseMovedX > Class15_GameWindowX && super.mouseMovedY - Class15_GameWindowY > l - 10 && super.mouseMovedY - Class15_GameWindowY <= l + 3)
					{
						int i1 = aClass30_Sub2_Sub1_Sub4_1271.method383(anInt1116, "From:  " + s + aStringArray944[j]) + 25;
						if(i1 > 450)
							i1 = 450;
						if(super.mouseMovedX < Class15_GameWindowX + i1)
						{
							if(playerRights >= 1)
							{
								aStringArray1199[anInt1133] = "TextClientCreator's client " + s; //"Kihomura's client "
	...
	public final void method133(byte byte0)
	{
		...
		for(int l = 0; l < 33920; l++)
			Class15_LoginLeftGobFire.imagePixelsArray[l] = aClass30_Sub2_Sub1_Sub1_1201.anIntArray1439[l];
		...
		for(int k1 = 1; k1 < c - 1; k1++)
		{
			...
			for(int l2 = j2; l2 < 128; l2++)
			{
				...
				if(j3 != 0)
				{
					...
					int j4 = 256 - j3;
					j3 = anIntArray850[j3];
					int l4 = Class15_LoginLeftGobFire.imagePixelsArray[j1];
					Class15_LoginLeftGobFire.imagePixelsArray[j1++] = ((j3 & 0xff00ff) * l3 + (l4 & 0xff00ff) * j4 & 0xff00ff00) + ((j3 & 0xff00) * l3 + (l4 & 0xff00) * j4 & 0xff0000) >> 8;
				} else
				{
					j1++;
				}
		...
		Class15_LoginLeftGobFireX = (gFrame.getWidth() - 2*EGUI.translateGameX - 765)/2 + 0;
		Class15_LoginLeftGobFireY = 0;
		Class15_LoginLeftGobFire.GraphicsPositioner(Class15_LoginLeftGobFireY, super.graphics, Class15_LoginLeftGobFireX);
		for(int i2 = 0; i2 < 33920; i2++)
			Class15_LoginRightGobFire.imagePixelsArray[i2] = aClass30_Sub2_Sub1_Sub1_1202.anIntArray1439[i2];
		...
		for(int k2 = 1; k2 < c - 1; k2++)
		{
			...
			for(int i4 = 0; i4 < k3; i4++)
			{
				...
				if(k4 != 0)
				{
					...
					int j5 = 256 - k4;
					k4 = anIntArray850[k4];
					int k5 = Class15_LoginRightGobFire.imagePixelsArray[j1];
					Class15_LoginRightGobFire.imagePixelsArray[j1++] = ((k4 & 0xff00ff) * i5 + (k5 & 0xff00ff) * j5 & 0xff00ff00) + ((k4 & 0xff00) * i5 + (k5 & 0xff00) * j5 & 0xff0000) >> 8;
				} else
				{
					j1++;
				}
	...
	private final void method134(byte byte0, int i, Class30_Sub2_Sub2 class30_sub2_sub2)
	{
		...
		if(j > anInt891)
		{
			signlink.reporterror(playerName + " Too many players");
			throw new RuntimeException("eek");
		}
		anInt891 = 0;
		for(int l = 0; l < j; l++)
	...
	public final void method135(boolean flag, boolean flag1) {
		...
		int c = 360; //360, x-coord for text and buttons on loginscreen
		int c1 = 200; //200, y-coord for text and buttons on loginscreen
		if(flag1)
			return;
		if(anInt833 == 0) {
			int i = c1 / 2 + 80;
		...
		if(anInt833 == 2) {
			...
			aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffff, "@whi@Username: " + playerName + ((loginRowFocusedNbr == 0) & (anInt1161 % 40 < 20) ? "|" : ""), j);
			j += 15;
			aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffff, "@whi@Password: " + Class50.hidePass(playerPass) + ((loginRowFocusedNbr == 1) & (anInt1161 % 40 < 20) ? "|" : ""), j);
			j += 15;
			aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xfff00, ""/*"@whi@Server IP: " + server + ((anInt1216 == 2) & (anInt1105 % 40 < 20) ? "|" : "")*/, j);
			j += 15;
			aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xfff00, ""/*"@whi@Port: " + port + ((anInt1216 == 3) & (anInt1105 % 40 < 20) ? "|" : "")*/, j);
			j += 15;
			if(!flag) {
				int i1 = c / 2 - 80;
				int l1 = c1 / 2 + 50;
	...
	private final void method139(Class30_Sub2_Sub2 class30_sub2_sub2, int i, int j)//find
	{
		...
		if(k > anInt836)
		{
			signlink.reporterror(playerName + " Too many npcs");
			throw new RuntimeException("eek");
		}
		anInt836 = 0;
		for(int i1 = 0; i1 < k; i1++)
	...
	/**
	 * Clicking buttons on login screen
	 * @param flag
	 */
	public final void method140(boolean flag)
	{
		...
		if(anInt833 == 0)
		{
			// first login screen
			isTyping = true;
			int i = (gFrame.getWidth() - 2*EGUI.translateGameX) / 2 - 80;
			int l = 503 / 2 + 20;
			l += 20;
			if(super.anInt26 == 1 && super.mousePressedX2 >= i - 75
					&& super.mousePressedX2 <= i + 75
					&& super.mousePressedY2 >= l - 20
					&& super.mousePressedY2 <= l + 20)
			{
				anInt833 = 3;
				loginRowFocusedNbr = 0;
			}
			i = (gFrame.getWidth() - 2*EGUI.translateGameX) / 2 + 80;
			if(super.anInt26 == 1 && super.mousePressedX2 >= i - 75
					&& super.mousePressedX2 <= i + 75
					&& super.mousePressedY2 >= l - 20
					&& super.mousePressedY2 <= l + 20)
			...
			if(anInt833 == 2)
			{
				...
				j += 30;
				j += 25;
				if(super.anInt26 == 1 && super.mousePressedY2 >= j - 15
						&& super.mousePressedY2 < j)
					loginRowFocusedNbr = 0;
				j += 15;
				if(super.anInt26 == 1 && super.mousePressedY2 >= j - 15
						&& super.mousePressedY2 < j)
					loginRowFocusedNbr = 1;
				j += 15;
				int i1 = (gFrame.getWidth() - 2*EGUI.translateGameX) / 2 - 80;
				int k1 = 503 / 2 + 50;
				k1 += 20;
				if(super.anInt26 == 1 && super.mousePressedX2 >= i1 - 75
						&& super.mousePressedX2 <= i1 + 75
						&& super.mousePressedY2 >= k1 - 20
						&& super.mousePressedY2 <= k1 + 20)
				{ // click on login
					anInt1038 = 0;
					tryLogin(playerName, playerPass, false);
					if(aBoolean1157)
						return;
				}
				i1 = (gFrame.getWidth() - 2*EGUI.translateGameX) / 2 + 80;
				if(super.anInt26 == 1 && super.mousePressedX2 >= i1 - 75
						&& super.mousePressedX2 <= i1 + 75
						&& super.mousePressedY2 >= k1 - 20
						&& super.mousePressedY2 <= k1 + 20)
				...
				do
				{
					...
					if(loginRowFocusedNbr == 0)
					{ // username
						if(l1 == 8 && playerName.length() > 0)
					...
					} else if(loginRowFocusedNbr == 1)
					{ // password
						if(l1 == 8 && playerPass.length() > 0)
							playerPass = playerPass.substring(0, playerPass.length() - 1);
						// TODO: this should make you log in
						if(l1 == 9 || l1 == 10 || l1 == 13)
						{ // click on login
							anInt1038 = 0;
							tryLogin(playerName, playerPass, false);
						...
						if(playerPass.length() > 20)
							playerPass = playerPass.substring(0, 20);
					} else if(loginRowFocusedNbr == 2)
					{ // server
			...
			if(anInt833 == 3)
			{
				int k = (gFrame.getWidth() - 2*EGUI.translateGameX) / 2;
				int j1 = 503 / 2 + 50;
				j1 += 20;
				if(super.anInt26 == 1
						&& super.mousePressedX2 >= k - 75
						&& super.mousePressedX2 <= k + 75
						&& super.mousePressedY2 >= j1 - 20
						&& super.mousePressedY2 <= j1 + 20)
					anInt833 = 0;
			}
		}
	...
	public final void method141(Class30_Sub2_Sub1_Sub1 class30_sub2_sub1_sub1, int xCoord, int yCoord, boolean flag)
	{
		int k = anInt1185 + anInt1209 & 0x7ff;
		int l = xCoord * xCoord + yCoord * yCoord;
		if(flag)
			return;
		if(l > 6400)
			return;
		int i1 = Class30_Sub2_Sub4_Sub6.anIntArray1689[k]; //symbols on minimap X
		int j1 = Class30_Sub2_Sub4_Sub6.anIntArray1690[k];  //symbols on minimap Y
		i1 = (i1 * 256) / (anInt1170 + 256);
		j1 = (j1 * 256) / (anInt1170 + 256);
		int k1 = yCoord * i1 + xCoord * j1 >> 16;
		int l1 = yCoord * j1 - xCoord * i1 >> 16;
		if(l > 2500)
		{
			class30_sub2_sub1_sub1.method354(aClass30_Sub2_Sub1_Sub2_Mapback0, false, 83 - l1 - class30_sub2_sub1_sub1.anInt1445 / 2 - 4, ((94 + k1) - class30_sub2_sub1_sub1.anInt1444 / 2) + 4);
			return;
		} else
		{
	...
	private final void method143(int i, Class30_Sub2_Sub2 class30_sub2_sub2, int j)
	{
		...
		for(int i1 = 0; i1 < anInt891; i1++)
			...
			{
				signlink.reporterror(playerName + " null entry in pl list - pos:" + i1 + " size:" + anInt891);
				throw new RuntimeException("eek");
			}
	...
	public final boolean method145(boolean flag)
	{
		...
		{
			if(incPacketType != -1)
				System.out.println("pktType: "+incPacketType);
			int avail = aClass24_1168.getAvailableDataSize();
			if(avail == 0)
				return false;
			if(incPacketType == -1)
			{
				aClass24_1168.method270(aClass30_Sub2_Sub2_1083.cacheData, 0, 1);
				incPacketType = aClass30_Sub2_Sub2_1083.cacheData[0] & 0xff;
				if(aClass17_1000 != null)
					incPacketType = incPacketType - aClass17_1000.method246() & 0xff;
				packetSize = Class31.packetSizes[incPacketType];
				avail--;
			}
			if(packetSize == -1)
				if(avail > 0)
				{
					aClass24_1168.method270(aClass30_Sub2_Sub2_1083.cacheData, 0, 1);
					packetSize = aClass30_Sub2_Sub2_1083.cacheData[0] & 0xff;
					avail--;
				} else
				{
					return false;
			...
			if(packetSize == -2)
				if(avail > 1)
				{
					aClass24_1168.method270(aClass30_Sub2_Sub2_1083.cacheData, 0, 2);
					aClass30_Sub2_Sub2_1083.anInt1406 = 0;
					packetSize = aClass30_Sub2_Sub2_1083.method410();
					avail -= 2;
				} else
				{
					return false;
			...
			if(avail < packetSize)
				return false;
			aClass30_Sub2_Sub2_1083.anInt1406 = 0;
			aClass24_1168.method270(aClass30_Sub2_Sub2_1083.cacheData, 0, packetSize);
			anInt1009 = 0;
			anInt843 = anInt842;
			anInt842 = anInt841;
			anInt841 = incPacketType;
			if(incPacketType == 81)
			{
				method143(packetSize, aClass30_Sub2_Sub2_1083, 9759);
				aBoolean1080 = false;
				incPacketType = -1;
				return true;
			}
			...
			else
			{
				if(showframeids == 1)
				{
					System.out.println("Frameid:" + incPacketType);
				}
				//System.out.println("Byte:" + Class9.aClass9Array210);
			}
			if(incPacketType == 176)
			{
			...
			if(incPacketType == 185)
			{
				...
				{
					Class9.aClass9Array210[k].anInt234 = (aClass30_Sub2_Sub4_Sub1_Sub2_1126.anIntArray1700[0] << 25)
							+ (aClass30_Sub2_Sub4_Sub1_Sub2_1126.anIntArray1700[4] << 20)
							+ (aClass30_Sub2_Sub4_Sub1_Sub2_1126.anIntArray1717[0] << 15)
							+ (aClass30_Sub2_Sub4_Sub1_Sub2_1126.anIntArray1717[8] << 10)
							+ (aClass30_Sub2_Sub4_Sub1_Sub2_1126.anIntArray1717[11] << 5)
							+ aClass30_Sub2_Sub4_Sub1_Sub2_1126.anIntArray1717[1];
				} else
					Class9.aClass9Array210[k].anInt234 = (int)(0x12345678L + aClass30_Sub2_Sub4_Sub1_Sub2_1126.aClass5_1698.aLong78);
				incPacketType = -1;
				return true;
			}
			if(incPacketType == 107)
			{
				aBoolean1160 = false;
				for(int l = 0; l < 5; l++)
			...
			if(incPacketType == 214)
			{
				anInt822 = packetSize / 8;
			...
			if(incPacketType == 70)
			{
				...
				class9_5.panelXOffsetExtra = k2;
				class9_5.panelYOffsetExtra = l10;
				incPacketType = -1;
				return true;
			}
			if(incPacketType == 73 || incPacketType == 241)
			{
				int l2 = anInt1069;
				int i11 = anInt1070;
				if(incPacketType == 73)
				...
				anInt1023 = 1;
				aLong824 = System.currentTimeMillis();
				/* We do this when we first load the viewport
				Class15_GameWindow.method237();
				aClass30_Sub2_Sub1_Sub4_1271.method381(0, "Loading - Please wait....", 23693, Class15_GameWindowHeight/2 - 16, Class15_GameWindowWidth/2 + 1);
				aClass30_Sub2_Sub1_Sub4_1271.method381(0xffffff, "Loading - Please wait....", 23693, Class15_GameWindowHeight/2 - 17, Class15_GameWindowWidth/2);
				Class15_GameWindow.GraphicsPositioner(Class15_GameWindowY, super.graphics, Class15_GameWindowX);
			...
			if(incPacketType == 208)
			{
				...
				anInt1018 = i3; // this value creates the wildy level skull
				incPacketType = -1;
			...
			if(incPacketType == 60)
			{
				...
				anInt1268 = aClass30_Sub2_Sub2_1083.method427(false);
				while(aClass30_Sub2_Sub2_1083.anInt1406 < packetSize)
				{
			...
			if(incPacketType == 253)
			{
				...
				{
					String s3 = s.substring(0, s.indexOf(":"));
					long l17 = Class50.stringToLong(s3);
					boolean flag9 = false;
					...
					if(s.endsWith(":tradereq:"))
					{
						...
						if(s.endsWith(":duelreq:"))
						{
							...
							long l18 = Class50.stringToLong(s4);
							boolean flag3 = false;
							...
							if(s.endsWith(":chalreq:"))
							{
								...
								long l19 = Class50.stringToLong(s5);
								boolean flag4 = false;
			...
			if(incPacketType == 79)
			{
				...
				if(class9_3 != null && class9_3.anInt262 == 0)
				{
					if(l12 < 0)
						l12 = 0;
					if(l12 > class9_3.anInt261 - class9_3.frameHeight)
						l12 = class9_3.anInt261 - class9_3.frameHeight;
			...
			if(incPacketType == 196)
			{
					...
					try
				{
						...
						String s9 = Class35.method525(packetSize - 13, true, aClass30_Sub2_Sub2_1083);
						if(l21 != 3)
			...
			if(incPacketType == 65)
			{
				method31(aClass30_Sub2_Sub2_1083, packetSize, 973);
				incPacketType = -1;
				return true;
			}
			if(incPacketType == 27)
			...
			if(incPacketType == 105 || incPacketType == 84 ||
					incPacketType == 147 || incPacketType == 215 ||
					incPacketType == 4 || incPacketType == 117 ||
					incPacketType == 156 || incPacketType == 44 ||
					incPacketType == 160 || incPacketType == 101 ||
					incPacketType == 151)
			{
				method137(anInt1119, aClass30_Sub2_Sub2_1083, incPacketType);
				incPacketType = -1;
				return true;
			}
			if(incPacketType == 106)
			{
			...
			signlink.reporterror("T1 - " + incPacketType + "," + packetSize + " - " + anInt842 + "," + anInt843);
			method44(true);
		}
		catch(IOException _ex)
		{
		...
		{
			try {
				String s2 = "T2 - " + incPacketType + "," + anInt842 + "," +
						anInt843 + " - " + packetSize + "," +
						(anInt1034 + ((Class30_Sub2_Sub4_Sub1) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0]) + "," +
						(anInt1035 + ((Class30_Sub2_Sub4_Sub1) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0]) + " - ";
				for(int j15 = 0; j15 < packetSize && j15 < 50; j15++)
					s2 = s2 + aClass30_Sub2_Sub2_1083.cacheData[j15] + ",";
			} catch (Exception e) {
			}
	...
	public final void method146(byte byte0)
	{
		...
		} else
		{
			try {
				...
				method61(-252);
				method37(854, k2); //don't know what this does
				method112(8); //clicking on interfaces (not buttons) and viewport

				/*Placing interface inside 3d-viewport before updating it*/
				/*
				 * TODO: make this more efficient.
				 * Perhaps find a way to make the interface always be on
				 * top of the viewport. Otherwise I might just put the
				 * interface inside the viewport when the new frame is
				 * being written to Class15_GameWindow.gamePixelsArray.
				 * Need to find out where that happens. Probably in one
				 * or more of the functions above.
				 */
				Class15[] interfaceNames = {
						/*Chat*/
						Class15_Chatbox, Class15_BackLeft20, Class15_BackVMid30, Class15_BackHmMd20, Class15_Backbase10,
						/*Inventory*/
						Class15_InvBack0, Class15_BackVMid20, Class15_backRight20, Class15_BackHmid10, Class15_Backbase20,
						/*Minimap*/
						Class15_Mapback0, Class15_Mapback01, Class15_BackVMid10, Class15_BackRight10,
						/*Frame*/
						Class15_BackTop10, Class15_BackLeft10};
				int[] interfaceX = {
						/*Chat*/
						Class15_ChatboxX, Class15_BackLeft20X, Class15_BackVMid30X, Class15_BackHmMd20X, Class15_Backbase10X,
						/*Inventory*/
						Class15_InvBack0X, Class15_BackVMid20X, Class15_backRight20X, Class15_BackHmid10X, Class15_Backbase20X,
						/*Minimap*/
						Class15_Mapback0X, Class15_Mapback01X, Class15_BackVMid10X, Class15_BackRight10X,
						/*Frame*/
						Class15_BackTop10X, Class15_BackLeft10X};
				int[] interfaceY = {
						/*Chat*/
						Class15_ChatboxY, Class15_BackLeft20Y, Class15_BackVMid30Y, Class15_BackHmMd20Y, Class15_Backbase10Y,
						/*Inventory*/
						Class15_InvBack0Y, Class15_BackVMid20Y, Class15_backRight20Y, Class15_BackHmid10Y, Class15_Backbase20Y,
						/*Minimap*/
						Class15_Mapback0Y, Class15_Mapback01Y, Class15_BackVMid10Y, Class15_BackRight10Y,
						/*Frame*/
						Class15_BackTop10Y, Class15_BackLeft10Y};
				int[] interfaceWidth = {
						/*Chat*/
						Class15_ChatboxWidth, Class15_BackLeft20Width, Class15_BackVMid30Width, Class15_BackHmMd20Width, Class15_Backbase10Width,
						/*Inventory*/
						Class15_InvBack0Width, Class15_BackVMid20Width, Class15_backRight20Width, Class15_BackHmid10Width, Class15_Backbase20Width,
						/*Minimap*/
						Class15_Mapback0Width, Class15_Mapback01Width, Class15_BackVMid10Width, Class15_BackRight10Width,
						/*Frame*/
						Class15_BackTop10Width, Class15_BackLeft10Width};
				int[] interfaceHeight = {
						/*Chat*/
						Class15_ChatboxHeight, Class15_BackLeft20Height, Class15_BackVMid30Height, Class15_BackHmMd20Height, Class15_Backbase10Height,
						/*Inventory*/
						Class15_InvBack0Height, Class15_BackVMid20Height, Class15_backRight20Height, Class15_BackHmid10Height, Class15_Backbase20Height,
						/*Minimap*/
						Class15_Mapback0Height, Class15_Mapback01Height, Class15_BackVMid10Height, Class15_BackRight10Height,
						/*Frame*/
						Class15_BackTop10Height, Class15_BackLeft10Height};
				for(int idx = 0; idx < interfaceNames.length; idx++)
				{
					for(int Y = interfaceY[idx]; Y < interfaceY[idx] + interfaceHeight[idx]; Y++)
					{
						if(Y - Class15_GameWindowY - Class15_GameWindowHeight >= 0)
							break;
						if(Y < Class15_GameWindowY)
							continue;
						for(int X= interfaceX[idx]; X < interfaceX[idx] + interfaceWidth[idx]; X++)
						{
							if(X - Class15_GameWindowX - Class15_GameWindowWidth > 0)
								continue;
							if(X - Class15_GameWindowX < 0)
								continue;
							Class15_GameWindow.imagePixelsArray[(X - Class15_GameWindowX) + (Y - Class15_GameWindowY)*Class15_GameWindowWidth] = interfaceNames[idx].getPixelsArray()[(X - interfaceX[idx]) + (Y - interfaceY[idx])*interfaceWidth[idx]];
						}
					}
				}
	...
	public client()
	{
		...
		aBoolean848 = true;
		anInt857 = -1;
		anIntArray864 = new int[Class45.nbrOfSkills];
		aBoolean872 = false;
		...
		aByte920 = 14;
		anInt921 = 732;
		skillIndexArray = new int[Class45.nbrOfSkills];
		aByte923 = 25;
		...
		sideIconsArray = new Class30_Sub2_Sub1_Sub1[14];
		/*
		sideIconsArray = new Class30_Sub2_Sub1_Sub1[13];
		 */
		aBoolean954 = true;
		...
		anInt985 = -1;
		aClass30_Sub2_Sub1_Sub1_Hitmarks = new Class30_Sub2_Sub1_Sub1[20];
		...
		aBoolean1031 = false;
		aClass30_Sub2_Sub1_Sub1_Mapfunctions = new Class30_Sub2_Sub1_Sub1[100];
		anInt1042 = -1;
		aBoolean1043 = false;
		anIntArray1044 = new int[Class45.nbrOfSkills];
		...
		aClass30_Sub2_Sub1_Sub2_Mapscenes = new Class30_Sub2_Sub1_Sub2[100];
		anInt1063 = 0x4d4233;
		...
		aClass30_Sub2_Sub1_Sub1_Headicons_prayer = new Class30_Sub2_Sub1_Sub1[20];
		aBoolean1103 = false;
		anInt1105 = 519;
		aBoolean1106 = false;
		anInt1116 = 445;
		...
		aBoolean1141 = false;
		aBoolean1149 = false;
		aClass30_Sub2_Sub1_Sub1_Cross = new Class30_Sub2_Sub1_Sub1[8];
		aBoolean1151 = true;
		aBoolean1153 = false;
		aBoolean1157 = false;
		aBoolean1158 = false;
		...
		aByte1217 = 6;
		anInt1218 = -589;
		aClass30_Sub2_Sub1_Sub2_Modicons = new Class30_Sub2_Sub1_Sub2[2];
		anInt1221 = 3;
		updatePlayerMsg = false;
		aBoolean1228 = true;
		...
		aByte1274 = -13;
		anInt1276 = -1;
		isTyping = true; // so we can typ in our username and password
		aBoolean1277 = true;
		anInt1279 = 2;
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Redstone2_2;
	private Class30_Sub2_Sub1_Sub2 aClass30_Sub2_Sub1_Sub1_Redstone3_1;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Redstone1_3;
	private Class30_Sub2_Sub1_Sub2 aClass30_Sub2_Sub1_Sub1_Redstone2_3;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapmarker0;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapmarker1;
	...
	private Class15 Class15_BackLeft10;
	private int Class15_BackLeft10Width;
	private int Class15_BackLeft10Height;
	private int Class15_BackLeft10X;
	private int Class15_BackLeft10Y;
	private Class15 Class15_BackLeft20;
	private int Class15_BackLeft20Width;
	private int Class15_BackLeft20Height;
	private int Class15_BackLeft20X;
	private int Class15_BackLeft20Y;
	private Class15 Class15_BackRight10;
	private int Class15_BackRight10Width;
	private int Class15_BackRight10Height;
	private int Class15_BackRight10X;
	private int Class15_BackRight10Y;
	private Class15 Class15_backRight20;
	private int Class15_backRight20Width;
	private int Class15_backRight20Height;
	private int Class15_backRight20X;
	private int Class15_backRight20Y;
	private Class15 Class15_BackTop10;
	private int Class15_BackTop10Width;
	private int Class15_BackTop10Height;
	private int Class15_BackTop10X;
	private int Class15_BackTop10Y;
	private Class15 Class15_BackVMid10;
	private int Class15_BackVMid10Width;
	private int Class15_BackVMid10Height;
	private int Class15_BackVMid10X;
	private int Class15_BackVMid10Y;
	private Class15 Class15_BackVMid20;
	private int Class15_BackVMid20Width;
	private int Class15_BackVMid20Height;
	private int Class15_BackVMid20X;
	private int Class15_BackVMid20Y;
	private Class15 Class15_BackVMid30;
	private int Class15_BackVMid30Width;
	private int Class15_BackVMid30Height;
	private int Class15_BackVMid30X;
	private int Class15_BackVMid30Y;
	private Class15 Class15_BackHmMd20;
	private int Class15_BackHmMd20Width;
	private int Class15_BackHmMd20Height;
	private int Class15_BackHmMd20X;
	private int Class15_BackHmMd20Y;
	private Class15 Class15_Mapback0; //new
	private int Class15_Mapback0Width;
	private int Class15_Mapback0Height;
	private int Class15_Mapback0X;
	private int Class15_Mapback0Y;
	...
	private Class30_Sub2_Sub1_Sub1 sideIconsArray[];
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Hitmarks[];
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapedge0;
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Scrollbar0;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Scrollbar1;
	private int anInt1026;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Backbase10;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Backbase20;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_BackHmid10;
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapfunctions[];
	...
	private Class30_Sub2_Sub1_Sub2 aClass30_Sub2_Sub1_Sub2_Mapscenes[];
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapdots0;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapdots1;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapdots2;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapdots3;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapdots4;
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Headicons_prayer[];
	...
	private Class15 Class15_LoginUpperArc;
	private int Class15_LoginUpperArcWidth;
	private int Class15_LoginUpperArcHeight;
	private int Class15_LoginUpperArcX;
	private int Class15_LoginUpperArcY;
	private Class15 Class15_LoginLowerArc;
	private int Class15_LoginLowerArcWidth;
	private int Class15_LoginLowerArcHeight;
	private int Class15_LoginLowerArcX;
	private int Class15_LoginLowerArcY;
	private Class15 Class15_LoginMiddleArc;
	private int Class15_LoginMiddleArcWidth;
	private int Class15_LoginMiddleArcHeight;
	private int Class15_LoginMiddleArcX;
	private int Class15_LoginMiddleArcY;
	private Class15 Class15_LoginLeftGobFire;
	private int Class15_LoginLeftGobFireWidth;
	private int Class15_LoginLeftGobFireHeight;
	private int Class15_LoginLeftGobFireX;
	private int Class15_LoginLeftGobFireY;
	private Class15 Class15_LoginRightGobFire;
	private int Class15_LoginRightGobFireWidth;
	private int Class15_LoginRightGobFireHeight;
	private int Class15_LoginRightGobFireX;
	private int Class15_LoginRightGobFireY;
	private Class15 Class15_LoginLeftGoblet;
	private int Class15_LoginLeftGobletWidth;
	private int Class15_LoginLeftGobletHeight;
	private int Class15_LoginLeftGobletX;
	private int Class15_LoginLeftGobletY;
	private Class15 Class15_LoginRightGoblet;
	private int Class15_LoginRightGobletWidth;
	private int Class15_LoginRightGobletHeight;
	private int Class15_LoginRightGobletX;
	private int Class15_LoginRightGobletY;
	private Class15 Class15_LeftLeftover;
	private int Class15_LeftLeftoverWidth;
	private int Class15_LeftLeftoverHeight;
	private int Class15_LeftLeftoverX;
	private int Class15_LeftLeftoverY;
	private Class15 Class15_RightLeftover;
	private int Class15_RightLeftoverWidth;
	private int Class15_RightLeftoverHeight;
	private int Class15_RightLeftoverX;
	private int Class15_RightLeftoverY;
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Compass0;
	private Class15 Class15_Backbase10;
	private int Class15_Backbase10Width;
	private int Class15_Backbase10Height;
	private int Class15_Backbase10X;
	private int Class15_Backbase10Y;
	private Class15 Class15_Backbase20;
	private int Class15_Backbase20Width;
	private int Class15_Backbase20Height;
	private int Class15_Backbase20X;
	private int Class15_Backbase20Y;
	private Class15 Class15_BackHmid10;
	private int Class15_BackHmid10Width;
	private int Class15_BackHmid10Height;
	private int Class15_BackHmid10X;
	private int Class15_BackHmid10Y;
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Redstone1_0;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Redstone2_0;
	private Class30_Sub2_Sub1_Sub2 aClass30_Sub2_Sub1_Sub1_Redstone3_0;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Redstone1_1;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Redstone2_1;
	private int anInt1148;
	private boolean aBoolean1149;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Cross[];
	...
	private Class15 Class15_InvBack0;
	private int Class15_InvBack0Width;
	private int Class15_InvBack0Height;
	private int Class15_InvBack0X;
	private int Class15_InvBack0Y;
	private Class15 Class15_Mapback01;
	private int Class15_Mapback01Width;
	private int Class15_Mapback01Height;
	private int Class15_Mapback01X;
	private int Class15_Mapback01Y;
	private Class15 Class15_GameWindow;
	private int Class15_GameWindowX;
	private int Class15_GameWindowY;
	private int Class15_GameWindowWidth;
	private int Class15_GameWindowHeight;
	private Class15 Class15_Chatbox;
	private int Class15_ChatboxWidth;
	private int Class15_ChatboxHeight;
	private int Class15_ChatboxX;
	private int Class15_ChatboxY;
	...
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Invback0;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Mapback0; //newmap
	private Class30_Sub2_Sub1_Sub2 aClass30_Sub2_Sub1_Sub2_Mapback0;
	private Class30_Sub2_Sub1_Sub1 aClass30_Sub2_Sub1_Sub1_Chatback0;
	...
	private Class30_Sub2_Sub1_Sub2 aClass30_Sub2_Sub1_Sub2_Modicons[];
	long aLong1220;
	private int anInt1221;
	private int anInt1222;
	private boolean updatePlayerMsg;
