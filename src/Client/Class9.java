...
/**
 * This class seems to be a lot of panels, such as
 * the panel where all of the magic spells are displayed,
 * the panel where all of the bank items are displayed,
 * the wilderness level and skull panel etc.
 * @author marcus
 *
 */
public class Class9
{
    ...
    public int anInt261;
    public int anInt262;
    public int panelXOffsetExtra;
    static Class12 aClass12_264 = new Class12(false, 30);
    public int panelYOffsetExtra;
    ...
    public static void method205(Class44 class44, Class30_Sub2_Sub1_Sub4 aclass30_sub2_sub1_sub4[], byte byte0, Class44 class44_1)
    {
        ...
        Class30_Sub2_Sub2 class30_sub2_sub2 = new Class30_Sub2_Sub2(class44.loadCache("data", null), 891);
        int i = -1;
        int j = class30_sub2_sub2.method410(); // number of entries in 'data'
        aClass9Array210 = new Class9[j];
        do
        {
            if(class30_sub2_sub2.anInt1406 >= class30_sub2_sub2.cacheData.length)
            {
                break;
            }
            ...
            class9.frameWidth = class30_sub2_sub2.method410();
            class9.frameHeight = class30_sub2_sub2.method410();
            ...
            if(class9.anInt262 == 0)
            {
                ...
                class9.panelXOffset = new int[l1];
                class9.panelYOffset = new int[l1];
                for(int k3 = 0; k3 < l1; k3++)
                {
                	class9.anIntArray240[k3] = class30_sub2_sub2.method410();
                	class9.panelXOffset[k3] = class30_sub2_sub2.method411();
                	class9.panelYOffset[k3] = class30_sub2_sub2.method411();
                }
            ...
            {
                class9.anIntArray253 = new int[class9.frameWidth * class9.frameHeight];
                class9.anIntArray252 = new int[class9.frameWidth * class9.frameHeight];
                ...
                for(int i2 = 0; i2 < 20; i2++)
                {
                    ...
                    if(class44_1 != null && s1.length() > 0)
                    {
                        ...
                        //System.out.println(Integer.parseInt(s1.substring(i5 + 1))+" "+s1.substring(0, i5));
                        //prayeron/prayeroff might be stored here
    ...
    private static Class30_Sub2_Sub1_Sub1 method207(int i, boolean flag, Class44 class44, String s)
    {
        ...
        {
        	/*
        	 * prayeron is only the background
        	 * prayeroff seems to be icon and background or just icon
        	 */
