...
public final class Class30_Sub2_Sub1_Sub4 extends Class30_Sub2_Sub1
{
    ...
    public Class30_Sub2_Sub1_Sub4(boolean flag, String s, int i, Class44 class44)
    {
        ...
        aBoolean1499 = false;
        Class30_Sub2_Sub2 class30_sub2_sub2 = new Class30_Sub2_Sub2(class44.loadCache(s + ".dat", null), 891);
    ...
    public void method381(int textColor, String text, int flag, int yCoord, int xCoord)
    {
        if(flag != 23693)
            anInt1489 = 467;
        method385(textColor, text, yCoord, 822, xCoord - method384(text, true) / 2);
    }

    public void method382(int textColor, int xCoord, int k, String text, int yCoord, boolean flag)
    {
        k = 74 / k;
        method389(false, flag, xCoord - method383(anInt1485, text) / 2, textColor, text, yCoord);
    }
    ...
    public int method383(int i, String s)
    {
        ...
        {
        	//errorhandling
        	if(s.charAt(k) > anIntArray1496.length)
        		continue;
    ...
    public void method385(int textColor, String text, int yCoord, int k, int offset)
    {
        if(text == null)
            return;
        yCoord -= anInt1497;
        ...
        {
        	//errorhandling
        	if(text.charAt(i1) > anIntArray1496.length)
        		continue;
            char c = text.charAt(i1);
            if(c != ' ')
                method392(aByteArrayArray1491[c], offset + anIntArray1494[c], yCoord + anIntArray1495[c], anIntArray1492[c], anIntArray1493[c], textColor);
            offset += anIntArray1496[c];
        }
    ...
    public void method386(int i, boolean flag, String s, int j, int k, int l)
    {
        ...
        {
        	//errorhandling
        	if(s.charAt(i1) > anIntArray1496.length)
        		continue;
            char c = s.charAt(i1);
            if(c != ' ')
    ...
    public void method388(int i, String s, boolean flag, int j, int k, int l, int i1)
    {
        ...
        {
        	//errorhandling
        	if(s.charAt(k1) > anIntArray1496.length)
        		continue;
            char c = s.charAt(k1);
            if(c != ' ')
    ...
    public void method389(boolean flag, boolean flag1, int i, int j, String s, int k)
    {
        ...
        if(flag)
            return;
        /*
         * red line over text, like when you have completed
         * part of a quest objective.
         */
        if(aBoolean1499)
            Class30_Sub2_Sub1.ForegroundColorHoriz1(k + (int)((double)anInt1497 * 0.69999999999999996D), 0x800000, i - l, l);
    }
    ...
    /**
     * handles coloring of strings i think.
     * @param s
     * @param i
     * @return
     */
    ...
    {
        int j1 = i + j * Class30_Sub2_Sub1.width;
        int k1 = Class30_Sub2_Sub1.width - k;
        int l1 = 0;
        int i2 = 0;
        if(j < Class30_Sub2_Sub1.startHeight)
        {
            ...
            i2 += j2 * k;
            j1 += j2 * Class30_Sub2_Sub1.width;
        }
        if(j + l >= Class30_Sub2_Sub1.endHeight)
            l -= ((j + l) - Class30_Sub2_Sub1.endHeight) + 1;
        ...
        if(i + k >= Class30_Sub2_Sub1.endWidth)
        {
            int l2 = ((i + k) - Class30_Sub2_Sub1.endWidth) + 1;
            k -= l2;
            l1 += l2;
            k1 += l2;
        }
        ...
        {
            method393(Class30_Sub2_Sub1.pixelsArray, abyte0, i1, i2, j1, k, l, k1, l1);
            return;
        }
    }

    /**
     * This handles display of all text it seems
     * @param ai
     * @param abyte0
     * @param i
     * @param j
    ...
    private void method394(int i, int j, byte abyte0[], int k, int l, int i1, boolean flag, 
            int j1)
    {
        int k1 = j + l * Class30_Sub2_Sub1.width;
        int l1 = Class30_Sub2_Sub1.width - k;
        int i2 = 0;
        int j2 = 0;
        if(l < Class30_Sub2_Sub1.startHeight)
        {
            int k2 = Class30_Sub2_Sub1.startHeight - l;
            i1 -= k2;
            l = Class30_Sub2_Sub1.startHeight;
            j2 += k2 * k;
            k1 += k2 * Class30_Sub2_Sub1.width;
        }
        if(l + i1 >= Class30_Sub2_Sub1.endHeight)
            i1 -= ((l + i1) - Class30_Sub2_Sub1.endHeight) + 1;
        if(j < Class30_Sub2_Sub1.startWidth)
        {
            int l2 = Class30_Sub2_Sub1.startWidth - j;
            k -= l2;
        ...
        if(j + k >= Class30_Sub2_Sub1.endWidth)
        {
            int i3 = ((j + k) - Class30_Sub2_Sub1.endWidth) + 1;
            k -= i3;
            i2 += i3;
            l1 += i3;
        }
        if(k <= 0 || i1 <= 0)
            return;
        method395(abyte0, i1, k1, Class30_Sub2_Sub1.pixelsArray, 520, j2, k, i2, l1, j1, i);
        if(flag)
        {
