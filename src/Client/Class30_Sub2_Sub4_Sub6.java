...
public class Class30_Sub2_Sub4_Sub6 extends Class30_Sub2_Sub4
{
            ...
            int l1, int i2)
    {
        ...
        if(k3 / i3 >= Class30_Sub2_Sub1.endWidthHalf)
            return;
        int l3 = j3 + anInt1650 << 9;
        if(l3 / i3 <= -Class30_Sub2_Sub1.endWidthHalf)
            return;
        int i4 = k1 * k - j2 * j >> 16;
        int j4 = anInt1650 * j >> 16;
        int k4 = i4 + j4 << 9;
        if(k4 / i3 <= -Class30_Sub2_Sub1.endHeightHalf)
            return;
        int l4 = j4 + (super.anInt1426 * k >> 16);
        int i5 = i4 - l4 << 9;
        if(i5 / i3 >= Class30_Sub2_Sub1.endHeightHalf)
            return;
            ...
            if(anIntArray1637 == null || anIntArray1637[k] != -1)
            {
                ...
                } else
                {
                    ...
                    if((i3 - l3) * (anIntArray1666[j2] - anIntArray1666[k1]) - (anIntArray1666[l] - anIntArray1666[k1]) * (k4 - l3) > 0)
                    {
                        ...
                        if(i3 < 0 || l3 < 0 || k4 < 0 || i3 > Class30_Sub2_Sub1.endWidthMinusOne || l3 > Class30_Sub2_Sub1.endWidthMinusOne || k4 > Class30_Sub2_Sub1.endWidthMinusOne)
    ...
    private final void method485(int i)
    {
        ...
        if((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0)
        {
            ...
            if(l == 3)
            {
                if(j3 < 0 || j4 < 0 || j5 < 0 || j3 > Class30_Sub2_Sub1.endWidthMinusOne || j4 > Class30_Sub2_Sub1.endWidthMinusOne || j5 > Class30_Sub2_Sub1.endWidthMinusOne)
            ...
            if(l == 4)
            {
                if(j3 < 0 || j4 < 0 || j5 < 0 || j3 > Class30_Sub2_Sub1.endWidthMinusOne || j4 > Class30_Sub2_Sub1.endWidthMinusOne || j5 > Class30_Sub2_Sub1.endWidthMinusOne || anIntArray1678[3] < 0 || anIntArray1678[3] > Class30_Sub2_Sub1.endWidthMinusOne)
                    Class30_Sub2_Sub1_Sub3.aBoolean1462 = true;
                int i8;
                if(anIntArray1637 == null)
                    i8 = 0;
