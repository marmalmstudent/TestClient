    ...
    implements Runnable
{
    ...
    public final void method551(Class44 class44, client client1)
    {
        ...
        for(int i = 0; i < 4; i++)
        {
            byte abyte0[] = class44.loadCache(as[i], null);
        ...
        for(int k = 0; k < 4; k++)
        {
            byte abyte1[] = class44.loadCache(as1[k], null);
        ...
        byte abyte2[] = class44.loadCache("model_index", null);
        ...
        abyte2 = class44.loadCache("map_index", null);
        ...
        abyte2 = class44.loadCache("anim_index", null);
        ...
        abyte2 = class44.loadCache("midi_index", null);
        class30_sub2_sub2_2 = new Class30_Sub2_Sub2(abyte2, 891);
        j1 = abyte2.length;
        ...
        aClient1343 = client1;
        aBoolean1353 = true;
        aClient1343.StartThread(this, 2);
    }
        ...
        try
        {
            if(aSocket1363 == null)
            {
                ...
                if(l - aLong1335 < 4000L)
                    return;
                aLong1335 = l;
                aSocket1363 = aClient1343.openSocket(43594 + client.portOffset);
